...
#include "GCN_JunkGun_Explosion_Underwater_classes.hpp"
#include "GCN_JunkGun_Explosion_Underwater_parameters.hpp"
...
void UGCN_JunkGun_Explosion_Underwater_C::OnBurstGeneric(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UFXSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UMatineeCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_JunkGun_Explosion_Underwater_C", "OnBurstGeneric");

	Params::GCN_JunkGun_Explosion_Underwater_C_OnBurstGeneric Parms{};
