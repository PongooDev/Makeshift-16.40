...
public:
	...
	class UFriendSubscriptionToastWidget_C*       NewVar_0;                                          // 0x0308(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(UToastDisplayArea_C, UberGraphFrame) == 0x0002F8, "Member 'UToastDisplayArea_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UToastDisplayArea_C, SafeZone_0) == 0x000300, "Member 'UToastDisplayArea_C::SafeZone_0' has a wrong offset!");
static_assert(offsetof(UToastDisplayArea_C, NewVar_0) == 0x000308, "Member 'UToastDisplayArea_C::NewVar_0' has a wrong offset!");
