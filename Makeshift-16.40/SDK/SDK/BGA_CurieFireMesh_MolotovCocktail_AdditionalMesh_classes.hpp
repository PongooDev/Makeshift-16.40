...
{
public:
	struct FScalableFloat                         SelfPropagationFuelRowValue;                       // 0x0868(0x0028)(Edit, BlueprintVisible, DisableEditOnInstance)
...
static_assert(sizeof(ABGA_CurieFireMesh_MolotovCocktail_AdditionalMesh_C) == 0x000890, "Wrong size on ABGA_CurieFireMesh_MolotovCocktail_AdditionalMesh_C");
static_assert(offsetof(ABGA_CurieFireMesh_MolotovCocktail_AdditionalMesh_C, SelfPropagationFuelRowValue) == 0x000868, "Member 'ABGA_CurieFireMesh_MolotovCocktail_AdditionalMesh_C::SelfPropagationFuelRowValue' has a wrong offset!");
