...
// 0x0198 (0x03F0 - 0x0258)
class AFortValetMod_Tire : public AFortValetModBase
{
public:
	struct FTireInfo                              TireData;                                          // 0x0258(0x0198)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AFortValetMod_Tire) == 0x0003F0, "Wrong size on AFortValetMod_Tire");
