...
static_assert(sizeof(UBP_AmbientAudioController_C) == 0x0001C8, "Wrong size on UBP_AmbientAudioController_C");
...
static_assert(offsetof(UBP_AmbientAudioController_C, Current_State) == 0x000169, "Member 'UBP_AmbientAudioController_C::Current_State' has a wrong offset!");
static_assert(offsetof(UBP_AmbientAudioController_C, Current_Room_Size_Tag) == 0x00016C, "Member 'UBP_AmbientAudioController_C::Current_Room_Size_Tag' has a wrong offset!");
static_assert(offsetof(UBP_AmbientAudioController_C, Reverbs) == 0x000178, "Member 'UBP_AmbientAudioController_C::Reverbs' has a wrong offset!");
