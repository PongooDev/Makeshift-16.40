...
static_assert(sizeof(UGA_FuelEquipped_C) == 0x000A78, "Wrong size on UGA_FuelEquipped_C");
static_assert(offsetof(UGA_FuelEquipped_C, UberGraphFrame) == 0x000A70, "Member 'UGA_FuelEquipped_C::UberGraphFrame' has a wrong offset!");
