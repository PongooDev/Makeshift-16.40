...
static_assert(sizeof(B_HeldObject_Parent_C_OnRep_IsHeld) == 0x000090, "Wrong size on B_HeldObject_Parent_C_OnRep_IsHeld");
...
static_assert(offsetof(B_HeldObject_Parent_C_OnRep_IsHeld, CallFunc_ApplyGlobalEnvironmentGameplayEffectToActor_ReturnValue) == 0x000088, "Member 'B_HeldObject_Parent_C_OnRep_IsHeld::CallFunc_ApplyGlobalEnvironmentGameplayEffectToActor_ReturnValue' has a wrong offset!");
