...
static_assert(offsetof(UPistol_Revolver_SideAction_AnimBP_C, AnimGraphNode_Root) == 0x0002C8, "Member 'UPistol_Revolver_SideAction_AnimBP_C::AnimGraphNode_Root' has a wrong offset!");
static_assert(offsetof(UPistol_Revolver_SideAction_AnimBP_C, AnimGraphNode_Slot) == 0x0002F8, "Member 'UPistol_Revolver_SideAction_AnimBP_C::AnimGraphNode_Slot' has a wrong offset!");
static_assert(offsetof(UPistol_Revolver_SideAction_AnimBP_C, AnimGraphNode_SequencePlayer) == 0x000340, "Member 'UPistol_Revolver_SideAction_AnimBP_C::AnimGraphNode_SequencePlayer' has a wrong offset!");
