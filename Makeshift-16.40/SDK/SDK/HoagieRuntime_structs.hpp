...
{
public:
	struct FFortHeliFlightModel                   FlightModel;                                       // 0x0050(0x0110)(NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FHoagieInternal) == 0x000168, "Wrong size on FHoagieInternal");
static_assert(offsetof(FHoagieInternal, FlightModel) == 0x000050, "Member 'FHoagieInternal::FlightModel' has a wrong offset!");
...
{
public:
	class UFortHoagieVehicleConfigs*              FortHoagieVehicleConfigs;                          // 0x0138(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EHoagieState                                  CurrentHoagieState;                                // 0x0140(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LastRotorImpulseTime;                              // 0x0144(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                RotorHitLinearImpulse;                             // 0x0148(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                RotorHitAngularImpulse;                            // 0x0154(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FHoagieInPersistent) == 0x000008, "Wrong alignment on FHoagieInPersistent");
static_assert(sizeof(FHoagieInPersistent) == 0x000160, "Wrong size on FHoagieInPersistent");
static_assert(offsetof(FHoagieInPersistent, FortHoagieVehicleConfigs) == 0x000138, "Member 'FHoagieInPersistent::FortHoagieVehicleConfigs' has a wrong offset!");
static_assert(offsetof(FHoagieInPersistent, CurrentHoagieState) == 0x000140, "Member 'FHoagieInPersistent::CurrentHoagieState' has a wrong offset!");
static_assert(offsetof(FHoagieInPersistent, LastRotorImpulseTime) == 0x000144, "Member 'FHoagieInPersistent::LastRotorImpulseTime' has a wrong offset!");
static_assert(offsetof(FHoagieInPersistent, RotorHitLinearImpulse) == 0x000148, "Member 'FHoagieInPersistent::RotorHitLinearImpulse' has a wrong offset!");
static_assert(offsetof(FHoagieInPersistent, RotorHitAngularImpulse) == 0x000154, "Member 'FHoagieInPersistent::RotorHitAngularImpulse' has a wrong offset!");
