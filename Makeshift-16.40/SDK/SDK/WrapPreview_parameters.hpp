...
static_assert(offsetof(WrapPreview_C_ExecuteUbergraph_WrapPreview, CallFunc_IsMobileGame_ReturnValue) == 0x000048, "Member 'WrapPreview_C_ExecuteUbergraph_WrapPreview::CallFunc_IsMobileGame_ReturnValue' has a wrong offset!");
