...
static_assert(sizeof(UJoinVoiceChannelButton_C) == 0x000C00, "Wrong size on UJoinVoiceChannelButton_C");
static_assert(offsetof(UJoinVoiceChannelButton_C, UberGraphFrame) == 0x000BF0, "Member 'UJoinVoiceChannelButton_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UJoinVoiceChannelButton_C, OnHover) == 0x000BF8, "Member 'UJoinVoiceChannelButton_C::OnHover' has a wrong offset!");
