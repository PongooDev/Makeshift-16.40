...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_GAT_Athena_PurpleStuff_C;           // 0x0A88(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(UGAT_Athena_PurpleStuff_C) == 0x000A98, "Wrong size on UGAT_Athena_PurpleStuff_C");
static_assert(offsetof(UGAT_Athena_PurpleStuff_C, UberGraphFrame_GAT_Athena_PurpleStuff_C) == 0x000A88, "Member 'UGAT_Athena_PurpleStuff_C::UberGraphFrame_GAT_Athena_PurpleStuff_C' has a wrong offset!");
static_assert(offsetof(UGAT_Athena_PurpleStuff_C, PlayerPawn) == 0x000A90, "Member 'UGAT_Athena_PurpleStuff_C::PlayerPawn' has a wrong offset!");
