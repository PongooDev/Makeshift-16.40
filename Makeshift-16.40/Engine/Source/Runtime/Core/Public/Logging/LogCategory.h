...
static_assert(sizeof(FLogCategoryBase) == 12, "FLogCategoryBase must match the engine's layout (12 bytes).");
static_assert(alignof(FLogCategoryBase) == 4, "FLogCategoryBase must match the engine's alignment.");
