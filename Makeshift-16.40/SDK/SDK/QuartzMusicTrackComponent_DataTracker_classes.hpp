...
static_assert(sizeof(UQuartzMusicTrackComponent_DataTracker_C) == 0x0001C0, "Wrong size on UQuartzMusicTrackComponent_DataTracker_C");
...
static_assert(offsetof(UQuartzMusicTrackComponent_DataTracker_C, TimerHandle) == 0x0001B8, "Member 'UQuartzMusicTrackComponent_DataTracker_C::TimerHandle' has a wrong offset!");
