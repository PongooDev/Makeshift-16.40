...
public:
	...
	struct FGameplayTag                           RefillGasTankTag;                                  // 0x0A80(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	struct FFortGameplayAbilityMontageInfo        RefillGasTankMontage;                              // 0x0A88(0x0058)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FGameplayTag                           CatchFireflyTag;                                   // 0x0AE0(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	struct FFortGameplayAbilityMontageInfo        FireflyCatchMontage;                               // 0x0AE8(0x0058)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FFortGameplayAbilityMontageInfo        RefillVehicleFuelMontage;                          // 0x0B40(0x0058)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FGameplayTag                           GasCanRefillVehicleTag;                            // 0x0B98(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UGA_DefaultPlayer_InteractSearch_C) == 0x000BA0, "Wrong size on UGA_DefaultPlayer_InteractSearch_C");
static_assert(offsetof(UGA_DefaultPlayer_InteractSearch_C, UberGraphFrame) == 0x000A70, "Member 'UGA_DefaultPlayer_InteractSearch_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_DefaultPlayer_InteractSearch_C, PlayerPawn) == 0x000A78, "Member 'UGA_DefaultPlayer_InteractSearch_C::PlayerPawn' has a wrong offset!");
static_assert(offsetof(UGA_DefaultPlayer_InteractSearch_C, RefillGasTankTag) == 0x000A80, "Member 'UGA_DefaultPlayer_InteractSearch_C::RefillGasTankTag' has a wrong offset!");
static_assert(offsetof(UGA_DefaultPlayer_InteractSearch_C, RefillGasTankMontage) == 0x000A88, "Member 'UGA_DefaultPlayer_InteractSearch_C::RefillGasTankMontage' has a wrong offset!");
static_assert(offsetof(UGA_DefaultPlayer_InteractSearch_C, CatchFireflyTag) == 0x000AE0, "Member 'UGA_DefaultPlayer_InteractSearch_C::CatchFireflyTag' has a wrong offset!");
static_assert(offsetof(UGA_DefaultPlayer_InteractSearch_C, FireflyCatchMontage) == 0x000AE8, "Member 'UGA_DefaultPlayer_InteractSearch_C::FireflyCatchMontage' has a wrong offset!");
static_assert(offsetof(UGA_DefaultPlayer_InteractSearch_C, RefillVehicleFuelMontage) == 0x000B40, "Member 'UGA_DefaultPlayer_InteractSearch_C::RefillVehicleFuelMontage' has a wrong offset!");
static_assert(offsetof(UGA_DefaultPlayer_InteractSearch_C, GasCanRefillVehicleTag) == 0x000B98, "Member 'UGA_DefaultPlayer_InteractSearch_C::GasCanRefillVehicleTag' has a wrong offset!");
