...
public:
	...
	class AFortPlayerControllerAthena*            K2Node_DynamicCast_AsFort_Player_Controller_Athena; // 0x0038(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0040(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_41[0x7];                                       // 0x0041(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class AFortPlayerController*>          CallFunc_GetLocalFortPlayerControllers_ReturnValue_1; // 0x0048(0x0010)(ReferenceParm)
	...
	class AFortPlayerControllerAthena*            K2Node_DynamicCast_AsFort_Player_Controller_Athena_1; // 0x0060(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
...
static_assert(offsetof(MinigameSettingsMachine_C_GetTeamSetting, Temp_bool_Variable) == 0x000004, "Member 'MinigameSettingsMachine_C_GetTeamSetting::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_GetTeamSetting, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x000005, "Member 'MinigameSettingsMachine_C_GetTeamSetting::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_GetTeamSetting, K2Node_Select_Default) == 0x000008, "Member 'MinigameSettingsMachine_C_GetTeamSetting::K2Node_Select_Default' has a wrong offset!");
