...
static_assert(sizeof(UGA_HeldObject_AbilityWeapon_C) == 0x000A80, "Wrong size on UGA_HeldObject_AbilityWeapon_C");
static_assert(offsetof(UGA_HeldObject_AbilityWeapon_C, UberGraphFrame) == 0x000A70, "Member 'UGA_HeldObject_AbilityWeapon_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_HeldObject_AbilityWeapon_C, PlayerPawn) == 0x000A78, "Member 'UGA_HeldObject_AbilityWeapon_C::PlayerPawn' has a wrong offset!");
