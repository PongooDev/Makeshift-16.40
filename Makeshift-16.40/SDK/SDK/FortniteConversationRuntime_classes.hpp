...
public:
	void ClientReceiveConversationGiftUINotification(const struct FConversationGiftUINotificationInfo& ConversationGiftUINotification);
...
static_assert(offsetof(UFortPlayerConversationComponent, ComponentToIndicator) == 0x0002E8, "Member 'UFortPlayerConversationComponent::ComponentToIndicator' has a wrong offset!");
