...
{
public:
	TSoftClassPtr<class UClass>                   StoreSelectionScreenClass;                         // 0x0408(0x0028)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FText                                   RegularStoreSelectedText;                          // 0x0430(0x0018)(Edit, NativeAccessSpecifierPublic)
	class FText                                   NonRegularStoreSelectedText;                       // 0x0448(0x0018)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UFortStoreSelectionData) == 0x000460, "Wrong size on UFortStoreSelectionData");
static_assert(offsetof(UFortStoreSelectionData, StoreSelectionScreenClass) == 0x000408, "Member 'UFortStoreSelectionData::StoreSelectionScreenClass' has a wrong offset!");
static_assert(offsetof(UFortStoreSelectionData, RegularStoreSelectedText) == 0x000430, "Member 'UFortStoreSelectionData::RegularStoreSelectedText' has a wrong offset!");
static_assert(offsetof(UFortStoreSelectionData, NonRegularStoreSelectedText) == 0x000448, "Member 'UFortStoreSelectionData::NonRegularStoreSelectedText' has a wrong offset!");
...
{
public:
	class UFortLazyImage*                         Image_Icon;                                        // 0x0BF0(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UCommonTextBlock*                       Text_Description;                                  // 0x0BF8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UCommonTextBlock*                       Text_Price;                                        // 0x0C00(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UCommonRichTextBlock*                   RichText_Label;                                    // 0x0C08(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortStoreSelectionOptionEntry) == 0x000C10, "Wrong size on UFortStoreSelectionOptionEntry");
static_assert(offsetof(UFortStoreSelectionOptionEntry, Image_Icon) == 0x000BF0, "Member 'UFortStoreSelectionOptionEntry::Image_Icon' has a wrong offset!");
static_assert(offsetof(UFortStoreSelectionOptionEntry, Text_Description) == 0x000BF8, "Member 'UFortStoreSelectionOptionEntry::Text_Description' has a wrong offset!");
static_assert(offsetof(UFortStoreSelectionOptionEntry, Text_Price) == 0x000C00, "Member 'UFortStoreSelectionOptionEntry::Text_Price' has a wrong offset!");
static_assert(offsetof(UFortStoreSelectionOptionEntry, RichText_Label) == 0x000C08, "Member 'UFortStoreSelectionOptionEntry::RichText_Label' has a wrong offset!");
...
public:
	...
	class UCommonButtonGroupLegacy*               EntryBoxButtonGroup;                               // 0x0460(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	class UCommonButtonLegacy*                    Button_Continue;                                   // 0x0488(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UCommonButtonLegacy*                    Button_Cancel;                                     // 0x0490(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	TArray<struct FItemData>                      StoreOptions;                                      // 0x04B0(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
