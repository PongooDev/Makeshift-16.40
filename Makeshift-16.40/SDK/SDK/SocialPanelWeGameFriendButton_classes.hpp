...
public:
	...
	class UCommonTextBlock*                       Text_LinkPrompt;                                   // 0x0C00(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(USocialPanelWeGameFriendButton_C) == 0x000C08, "Wrong size on USocialPanelWeGameFriendButton_C");
static_assert(offsetof(USocialPanelWeGameFriendButton_C, UberGraphFrame) == 0x000BF0, "Member 'USocialPanelWeGameFriendButton_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(USocialPanelWeGameFriendButton_C, OnHovered) == 0x000BF8, "Member 'USocialPanelWeGameFriendButton_C::OnHovered' has a wrong offset!");
static_assert(offsetof(USocialPanelWeGameFriendButton_C, Text_LinkPrompt) == 0x000C00, "Member 'USocialPanelWeGameFriendButton_C::Text_LinkPrompt' has a wrong offset!");
