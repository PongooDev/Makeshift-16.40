...
// class UCommonButtonLegacy*              ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

class UCommonButtonLegacy* UHorizontalTabList_C::Get_Tab_From_Id(class FName TabNameID)
{
	static class UFunction* Func = nullptr;
...
void UHorizontalTabList_C::HandleTabCreated(class FName TabNameID, class UCommonButtonLegacy* TabButton)
{
	static class UFunction* Func = nullptr;
...
void UHorizontalTabList_C::HandleTabRemoved(class FName TabNameID, class UCommonButtonLegacy* TabButton)
{
	static class UFunction* Func = nullptr;
