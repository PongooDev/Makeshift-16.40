...
namespace Offsets
{
	constexpr int32 GObjects          = 0x09418F08;
	constexpr int32 AppendString      = 0x00DB62BC;
	constexpr int32 GNames            = 0x09643080;
	constexpr int32 GWorld            = 0x095ECB60;
	constexpr int32 ProcessEvent      = 0x00BB11B0;
...
{
public:
	typedef FScriptInterface TCppType;
...
public:
	static class FFieldClass* StaticClass()
	{
		class FFieldClass* (*Fn)() = decltype(Fn)(InSDKUtils::GetImageBase() + 0x1977ECC);
		return Fn();
	}
};
static_assert(alignof(FInterfaceProperty) == 0x000008, "Wrong alignment on FInterfaceProperty");
static_assert(sizeof(FInterfaceProperty) == 0x000080, "Wrong size on FInterfaceProperty");
static_assert(offsetof(FInterfaceProperty, InterfaceClass) == 0x000078, "Member 'FInterfaceProperty::InterfaceClass' has a wrong offset!");
