...
static_assert(sizeof(AWaterBodyCustom) == 0x000DD0, "Wrong size on AWaterBodyCustom");
static_assert(offsetof(AWaterBodyCustom, CustomGenerator) == 0x000DC8, "Member 'AWaterBodyCustom::CustomGenerator' has a wrong offset!");
...
static_assert(sizeof(AWaterBodyLake) == 0x000DD0, "Wrong size on AWaterBodyLake");
static_assert(offsetof(AWaterBodyLake, LakeGenerator) == 0x000DC8, "Member 'AWaterBodyLake::LakeGenerator' has a wrong offset!");
...
static_assert(sizeof(AWaterBodyOcean) == 0x000DE0, "Wrong size on AWaterBodyOcean");
static_assert(offsetof(AWaterBodyOcean, OceanGenerator) == 0x000DC8, "Member 'AWaterBodyOcean::OceanGenerator' has a wrong offset!");
static_assert(offsetof(AWaterBodyOcean, CollisionExtents) == 0x000DD0, "Member 'AWaterBodyOcean::CollisionExtents' has a wrong offset!");
static_assert(offsetof(AWaterBodyOcean, HeightOffset) == 0x000DDC, "Member 'AWaterBodyOcean::HeightOffset' has a wrong offset!");
...
static_assert(sizeof(AWaterBodyRiver) == 0x000DF0, "Wrong size on AWaterBodyRiver");
static_assert(offsetof(AWaterBodyRiver, RiverGenerator) == 0x000DC8, "Member 'AWaterBodyRiver::RiverGenerator' has a wrong offset!");
static_assert(offsetof(AWaterBodyRiver, LakeTransitionMaterial) == 0x000DD0, "Member 'AWaterBodyRiver::LakeTransitionMaterial' has a wrong offset!");
static_assert(offsetof(AWaterBodyRiver, LakeTransitionMID) == 0x000DD8, "Member 'AWaterBodyRiver::LakeTransitionMID' has a wrong offset!");
static_assert(offsetof(AWaterBodyRiver, OceanTransitionMaterial) == 0x000DE0, "Member 'AWaterBodyRiver::OceanTransitionMaterial' has a wrong offset!");
static_assert(offsetof(AWaterBodyRiver, OceanTransitionMID) == 0x000DE8, "Member 'AWaterBodyRiver::OceanTransitionMID' has a wrong offset!");
