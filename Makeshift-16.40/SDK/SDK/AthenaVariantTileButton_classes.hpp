...
public:
	...
	class UImage*                                 Image_Conflict;                                    // 0x0C78(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UAthenaVariantTileButton_C) == 0x000C80, "Wrong size on UAthenaVariantTileButton_C");
static_assert(offsetof(UAthenaVariantTileButton_C, UberGraphFrame) == 0x000C68, "Member 'UAthenaVariantTileButton_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UAthenaVariantTileButton_C, WarningPulse) == 0x000C70, "Member 'UAthenaVariantTileButton_C::WarningPulse' has a wrong offset!");
static_assert(offsetof(UAthenaVariantTileButton_C, Image_Conflict) == 0x000C78, "Member 'UAthenaVariantTileButton_C::Image_Conflict' has a wrong offset!");
