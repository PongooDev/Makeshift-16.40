...
// NumValues: 0x0005
enum class ENiagaraDebugHudSystemVerbosity : uint32
{
	None                                     = 0,
	Minimal                                  = 1,
	Basic                                    = 2,
...
// Enum Niagara.ENiagaraFlipbookViewMode
// NumValues: 0x0009
enum class ENiagaraFlipbookViewMode : uint32
{
	Perspective                              = 0,
	OrthoFront                               = 1,
	OrthoBack                                = 2,
	...
	OrthoBottom                              = 6,
	Num                                      = 7,
	ENiagaraFlipbookViewMode_MAX             = 8,
};
...
public:
	...
	uint8                                         bHidden : 1;                                       // 0x0031(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
{
public:
	ENiagaraDebugHudSystemVerbosity               HudVerbosity;                                      // 0x0000(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableGpuReadback;                                // 0x0004(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_5[0x3];                                        // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FIntPoint                              HUDLocation;                                       // 0x0008(0x0008)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENiagaraDebugHudFont                          HUDFont;                                           // 0x0010(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bValidateSystemSimulationDataBuffers;              // 0x0014(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bValidateParticleDataBuffers;                      // 0x0015(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	ENiagaraDebugHudSystemVerbosity               SystemVerbosity;                                   // 0x0074(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bSystemShowBounds;                                 // 0x0078(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bSystemShowActiveOnlyInWorld;                      // 0x0079(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShowSystemVariables;                              // 0x007A(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	ENiagaraDebugHudFont                          SystemFont;                                        // 0x0090(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShowParticleVariables;                            // 0x0094(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_95[0x3];                                       // 0x0095(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FNiagaraDebugHUDVariable>       ParticlesVariables;                                // 0x0098(0x0010)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
	ENiagaraDebugHudFont                          ParticleFont;                                      // 0x00A8(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShowParticlesVariablesWithSystem;                 // 0x00AC(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_AD[0x3];                                       // 0x00AD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         MaxParticlesToDisplay;                             // 0x00B0(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENiagaraDebugPlaybackMode                     PlaybackMode;                                      // 0x00B4(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bPlaybackRateEnabled;                              // 0x00B5(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_B6[0x2];                                       // 0x00B6(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         PlaybackRate;                                      // 0x00B8(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bLoopTimeEnabled;                                  // 0x00BC(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_BD[0x3];                                       // 0x00BD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         LoopTime;                                          // 0x00C0(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShowGlobalBudgetInfo;                             // 0x00C4(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FNiagaraDebugHUDSettingsData) == 0x0000C8, "Wrong size on FNiagaraDebugHUDSettingsData");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, HudVerbosity) == 0x000000, "Member 'FNiagaraDebugHUDSettingsData::HudVerbosity' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bEnableGpuReadback) == 0x000004, "Member 'FNiagaraDebugHUDSettingsData::bEnableGpuReadback' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, HUDLocation) == 0x000008, "Member 'FNiagaraDebugHUDSettingsData::HUDLocation' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, HUDFont) == 0x000010, "Member 'FNiagaraDebugHUDSettingsData::HUDFont' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bValidateSystemSimulationDataBuffers) == 0x000014, "Member 'FNiagaraDebugHUDSettingsData::bValidateSystemSimulationDataBuffers' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bValidateParticleDataBuffers) == 0x000015, "Member 'FNiagaraDebugHUDSettingsData::bValidateParticleDataBuffers' has a wrong offset!");
...
static_assert(offsetof(FNiagaraDebugHUDSettingsData, SystemVerbosity) == 0x000074, "Member 'FNiagaraDebugHUDSettingsData::SystemVerbosity' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bSystemShowBounds) == 0x000078, "Member 'FNiagaraDebugHUDSettingsData::bSystemShowBounds' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bSystemShowActiveOnlyInWorld) == 0x000079, "Member 'FNiagaraDebugHUDSettingsData::bSystemShowActiveOnlyInWorld' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bShowSystemVariables) == 0x00007A, "Member 'FNiagaraDebugHUDSettingsData::bShowSystemVariables' has a wrong offset!");
...
static_assert(offsetof(FNiagaraDebugHUDSettingsData, SystemFont) == 0x000090, "Member 'FNiagaraDebugHUDSettingsData::SystemFont' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bShowParticleVariables) == 0x000094, "Member 'FNiagaraDebugHUDSettingsData::bShowParticleVariables' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, ParticlesVariables) == 0x000098, "Member 'FNiagaraDebugHUDSettingsData::ParticlesVariables' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, ParticleFont) == 0x0000A8, "Member 'FNiagaraDebugHUDSettingsData::ParticleFont' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bShowParticlesVariablesWithSystem) == 0x0000AC, "Member 'FNiagaraDebugHUDSettingsData::bShowParticlesVariablesWithSystem' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, MaxParticlesToDisplay) == 0x0000B0, "Member 'FNiagaraDebugHUDSettingsData::MaxParticlesToDisplay' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PlaybackMode) == 0x0000B4, "Member 'FNiagaraDebugHUDSettingsData::PlaybackMode' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bPlaybackRateEnabled) == 0x0000B5, "Member 'FNiagaraDebugHUDSettingsData::bPlaybackRateEnabled' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PlaybackRate) == 0x0000B8, "Member 'FNiagaraDebugHUDSettingsData::PlaybackRate' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bLoopTimeEnabled) == 0x0000BC, "Member 'FNiagaraDebugHUDSettingsData::bLoopTimeEnabled' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, LoopTime) == 0x0000C0, "Member 'FNiagaraDebugHUDSettingsData::LoopTime' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bShowGlobalBudgetInfo) == 0x0000C4, "Member 'FNiagaraDebugHUDSettingsData::bShowGlobalBudgetInfo' has a wrong offset!");
...
// ScriptStruct Niagara.NiagaraFlipbookTextureSource
// 0x0008 (0x0008 - 0x0000)
struct FNiagaraFlipbookTextureSource final
{
public:
...
static_assert(alignof(FNiagaraFlipbookTextureSource) == 0x000004, "Wrong alignment on FNiagaraFlipbookTextureSource");
static_assert(sizeof(FNiagaraFlipbookTextureSource) == 0x000008, "Wrong size on FNiagaraFlipbookTextureSource");
static_assert(offsetof(FNiagaraFlipbookTextureSource, SourceName) == 0x000000, "Member 'FNiagaraFlipbookTextureSource::SourceName' has a wrong offset!");

// ScriptStruct Niagara.NiagaraFlipbookTextureSettings
// 0x0030 (0x0030 - 0x0000)
struct FNiagaraFlipbookTextureSettings final
{
public:
	...
	struct FNiagaraFlipbookTextureSource          SourceBinding;                                     // 0x0008(0x0008)(Edit, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(alignof(FNiagaraFlipbookTextureSettings) == 0x000008, "Wrong alignment on FNiagaraFlipbookTextureSettings");
static_assert(sizeof(FNiagaraFlipbookTextureSettings) == 0x000030, "Wrong size on FNiagaraFlipbookTextureSettings");
static_assert(offsetof(FNiagaraFlipbookTextureSettings, OutputName) == 0x000000, "Member 'FNiagaraFlipbookTextureSettings::OutputName' has a wrong offset!");
static_assert(offsetof(FNiagaraFlipbookTextureSettings, SourceBinding) == 0x000008, "Member 'FNiagaraFlipbookTextureSettings::SourceBinding' has a wrong offset!");
static_assert(offsetof(FNiagaraFlipbookTextureSettings, FrameSize) == 0x000014, "Member 'FNiagaraFlipbookTextureSettings::FrameSize' has a wrong offset!");
static_assert(offsetof(FNiagaraFlipbookTextureSettings, TextureSize) == 0x00001C, "Member 'FNiagaraFlipbookTextureSettings::TextureSize' has a wrong offset!");
static_assert(offsetof(FNiagaraFlipbookTextureSettings, GeneratedTexture) == 0x000028, "Member 'FNiagaraFlipbookTextureSettings::GeneratedTexture' has a wrong offset!");
...
// ScriptStruct Niagara.VersionedNiagaraScript
// 0x0001 (0x0001 - 0x0000)
struct FVersionedNiagaraScript final
{
public:
	uint8                                         Pad_0[0x1];                                        // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FVersionedNiagaraScript) == 0x000001, "Wrong alignment on FVersionedNiagaraScript");
static_assert(sizeof(FVersionedNiagaraScript) == 0x000001, "Wrong size on FVersionedNiagaraScript");

// ScriptStruct Niagara.VersionedNiagaraScriptWeakPtr
// 0x0001 (0x0001 - 0x0000)
struct FVersionedNiagaraScriptWeakPtr final
{
public:
	uint8                                         Pad_0[0x1];                                        // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FVersionedNiagaraScriptWeakPtr) == 0x000001, "Wrong alignment on FVersionedNiagaraScriptWeakPtr");
static_assert(sizeof(FVersionedNiagaraScriptWeakPtr) == 0x000001, "Wrong size on FVersionedNiagaraScriptWeakPtr");
...
public:
	...
	struct FGuid                                  VariableGuid;                                      // 0x00D4(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bIsStaticSwitch;                                   // 0x00E4(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_E5[0x3];                                       // 0x00E5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         StaticSwitchDefaultValue;                          // 0x00E8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bAddedToNodeGraphDeepCopy;                         // 0x00EC(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bOutputIsPersistent;                               // 0x00ED(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_EE[0x2];                                       // 0x00EE(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   CachedNamespacelessVariableName;                   // 0x00F0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(FNiagaraVariableMetaData) == 0x000100, "Wrong size on FNiagaraVariableMetaData");
...
static_assert(offsetof(FNiagaraVariableMetaData, VariableGuid) == 0x0000D4, "Member 'FNiagaraVariableMetaData::VariableGuid' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableMetaData, bIsStaticSwitch) == 0x0000E4, "Member 'FNiagaraVariableMetaData::bIsStaticSwitch' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableMetaData, StaticSwitchDefaultValue) == 0x0000E8, "Member 'FNiagaraVariableMetaData::StaticSwitchDefaultValue' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableMetaData, bAddedToNodeGraphDeepCopy) == 0x0000EC, "Member 'FNiagaraVariableMetaData::bAddedToNodeGraphDeepCopy' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableMetaData, bOutputIsPersistent) == 0x0000ED, "Member 'FNiagaraVariableMetaData::bOutputIsPersistent' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableMetaData, CachedNamespacelessVariableName) == 0x0000F0, "Member 'FNiagaraVariableMetaData::CachedNamespacelessVariableName' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableMetaData, bCreatedInSystemEditor) == 0x0000F8, "Member 'FNiagaraVariableMetaData::bCreatedInSystemEditor' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableMetaData, bUseLegacyNameString) == 0x0000F9, "Member 'FNiagaraVariableMetaData::bUseLegacyNameString' has a wrong offset!");
