...
static_assert(sizeof(AB_WilliePete_WaterBodyChild_C) == 0x000F40, "Wrong size on AB_WilliePete_WaterBodyChild_C");
static_assert(offsetof(AB_WilliePete_WaterBodyChild_C, UberGraphFrame) == 0x000F30, "Member 'AB_WilliePete_WaterBodyChild_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AB_WilliePete_WaterBodyChild_C, debug) == 0x000F38, "Member 'AB_WilliePete_WaterBodyChild_C::debug' has a wrong offset!");
