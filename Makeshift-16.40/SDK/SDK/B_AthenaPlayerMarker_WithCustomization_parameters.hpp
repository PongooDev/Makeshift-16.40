...
public:
	...
	TSubclassOf<class AFortMapMarkerTopperActor>  K2Node_ClassDynamicCast_AsFort_Map_Marker_Topper_Actor; // 0x0128(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	...
	TSubclassOf<class UObject>                    CallFunc_Conv_SoftClassReferenceToClass_ReturnValue; // 0x0138(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	TSubclassOf<class AFortMapMarkerTopperActor>  K2Node_ClassDynamicCast_AsFort_Map_Marker_Topper_Actor_1; // 0x0140(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
