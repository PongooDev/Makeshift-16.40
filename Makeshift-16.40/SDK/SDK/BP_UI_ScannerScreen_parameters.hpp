...
public:
	...
	class UUI_ScannerScreen_C*                    K2Node_DynamicCast_AsUI_Scanner_Screen;            // 0x0068(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
