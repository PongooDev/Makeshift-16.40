...
static_assert(sizeof(FVkModuleBinaries) == 0x000038, "Wrong size on FVkModuleBinaries");
...
public:
	class FString                                 ModuleId;                                          // 0x0000(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVkModuleBinaries                      Binaries;                                          // 0x0010(0x0038)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FVkResolvedModule) == 0x000008, "Wrong alignment on FVkResolvedModule");
static_assert(sizeof(FVkResolvedModule) == 0x000048, "Wrong size on FVkResolvedModule");
