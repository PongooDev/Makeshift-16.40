...
public:
	...
	bool                                          UseThrowConsumableHudKeyActions;                   // 0x0DA8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(AB_UtilityItem_Generic_Athena_C) == 0x000DB0, "Wrong size on AB_UtilityItem_Generic_Athena_C");
static_assert(offsetof(AB_UtilityItem_Generic_Athena_C, UberGraphFrame) == 0x000DA0, "Member 'AB_UtilityItem_Generic_Athena_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AB_UtilityItem_Generic_Athena_C, UseThrowConsumableHudKeyActions) == 0x000DA8, "Member 'AB_UtilityItem_Generic_Athena_C::UseThrowConsumableHudKeyActions' has a wrong offset!");
