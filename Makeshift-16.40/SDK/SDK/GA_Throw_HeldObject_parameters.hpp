...
static_assert(sizeof(GA_Throw_HeldObject_C_ExecuteUbergraph_GA_Throw_HeldObject) == 0x0002B0, "Wrong size on GA_Throw_HeldObject_C_ExecuteUbergraph_GA_Throw_HeldObject");
...
static_assert(offsetof(GA_Throw_HeldObject_C_ExecuteUbergraph_GA_Throw_HeldObject, CallFunc_K2_SetActorLocation_ReturnValue) == 0x000260, "Member 'GA_Throw_HeldObject_C_ExecuteUbergraph_GA_Throw_HeldObject::CallFunc_K2_SetActorLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_Throw_HeldObject_C_ExecuteUbergraph_GA_Throw_HeldObject, CallFunc_Multiply_VectorFloat_ReturnValue) == 0x000264, "Member 'GA_Throw_HeldObject_C_ExecuteUbergraph_GA_Throw_HeldObject::CallFunc_Multiply_VectorFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_Throw_HeldObject_C_ExecuteUbergraph_GA_Throw_HeldObject, CallFunc_GetScaledCapsuleSize_OutRadius) == 0x000270, "Member 'GA_Throw_HeldObject_C_ExecuteUbergraph_GA_Throw_HeldObject::CallFunc_GetScaledCapsuleSize_OutRadius' has a wrong offset!");
static_assert(offsetof(GA_Throw_HeldObject_C_ExecuteUbergraph_GA_Throw_HeldObject, CallFunc_GetScaledCapsuleSize_OutHalfHeight) == 0x000274, "Member 'GA_Throw_HeldObject_C_ExecuteUbergraph_GA_Throw_HeldObject::CallFunc_GetScaledCapsuleSize_OutHalfHeight' has a wrong offset!");
static_assert(offsetof(GA_Throw_HeldObject_C_ExecuteUbergraph_GA_Throw_HeldObject, CallFunc_GetGravityZ_ReturnValue) == 0x000278, "Member 'GA_Throw_HeldObject_C_ExecuteUbergraph_GA_Throw_HeldObject::CallFunc_GetGravityZ_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_Throw_HeldObject_C_ExecuteUbergraph_GA_Throw_HeldObject, CallFunc_FMax_ReturnValue) == 0x00027C, "Member 'GA_Throw_HeldObject_C_ExecuteUbergraph_GA_Throw_HeldObject::CallFunc_FMax_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_Throw_HeldObject_C_ExecuteUbergraph_GA_Throw_HeldObject, K2Node_CustomEvent_TargetData_2) == 0x000280, "Member 'GA_Throw_HeldObject_C_ExecuteUbergraph_GA_Throw_HeldObject::K2Node_CustomEvent_TargetData_2' has a wrong offset!");
static_assert(offsetof(GA_Throw_HeldObject_C_ExecuteUbergraph_GA_Throw_HeldObject, K2Node_CustomEvent_ApplicationTag_2) == 0x0002A8, "Member 'GA_Throw_HeldObject_C_ExecuteUbergraph_GA_Throw_HeldObject::K2Node_CustomEvent_ApplicationTag_2' has a wrong offset!");
...
public:
	...
	class AB_HeldObject_Parent_C*                 K2Node_DynamicCast_AsB_Held_Object_Parent;         // 0x0038(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	...
	class AFortPlayerPawn*                        K2Node_DynamicCast_AsFort_Player_Pawn;             // 0x0090(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
...
static_assert(offsetof(GA_Throw_HeldObject_C_UpdateTrajectorySpline, CallFunc_IsValid_ReturnValue) == 0x0000B0, "Member 'GA_Throw_HeldObject_C_UpdateTrajectorySpline::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_Throw_HeldObject_C_UpdateTrajectorySpline, CallFunc_HitValidSocket_CanSocket) == 0x0000B1, "Member 'GA_Throw_HeldObject_C_UpdateTrajectorySpline::CallFunc_HitValidSocket_CanSocket' has a wrong offset!");
static_assert(offsetof(GA_Throw_HeldObject_C_UpdateTrajectorySpline, CallFunc_IsValid_ReturnValue_1) == 0x0000B2, "Member 'GA_Throw_HeldObject_C_UpdateTrajectorySpline::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
...
public:
	...
	class USphereComponent*                       K2Node_DynamicCast_AsSphere_Collision;             // 0x0110(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	...
	class AB_HeldObjectSocket_C*                  K2Node_DynamicCast_AsB_Held_Object_Socket;         // 0x0120(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
...
static_assert(offsetof(GA_Throw_HeldObject_C_HitValidSocket, CanSocket) == 0x000088, "Member 'GA_Throw_HeldObject_C_HitValidSocket::CanSocket' has a wrong offset!");
static_assert(offsetof(GA_Throw_HeldObject_C_HitValidSocket, CallFunc_BreakHitResult_bBlockingHit) == 0x000089, "Member 'GA_Throw_HeldObject_C_HitValidSocket::CallFunc_BreakHitResult_bBlockingHit' has a wrong offset!");
static_assert(offsetof(GA_Throw_HeldObject_C_HitValidSocket, CallFunc_BreakHitResult_bInitialOverlap) == 0x00008A, "Member 'GA_Throw_HeldObject_C_HitValidSocket::CallFunc_BreakHitResult_bInitialOverlap' has a wrong offset!");
static_assert(offsetof(GA_Throw_HeldObject_C_HitValidSocket, CallFunc_BreakHitResult_Time) == 0x00008C, "Member 'GA_Throw_HeldObject_C_HitValidSocket::CallFunc_BreakHitResult_Time' has a wrong offset!");
static_assert(offsetof(GA_Throw_HeldObject_C_HitValidSocket, CallFunc_BreakHitResult_Distance) == 0x000090, "Member 'GA_Throw_HeldObject_C_HitValidSocket::CallFunc_BreakHitResult_Distance' has a wrong offset!");
static_assert(offsetof(GA_Throw_HeldObject_C_HitValidSocket, CallFunc_BreakHitResult_Location) == 0x000094, "Member 'GA_Throw_HeldObject_C_HitValidSocket::CallFunc_BreakHitResult_Location' has a wrong offset!");
static_assert(offsetof(GA_Throw_HeldObject_C_HitValidSocket, CallFunc_BreakHitResult_ImpactPoint) == 0x0000A0, "Member 'GA_Throw_HeldObject_C_HitValidSocket::CallFunc_BreakHitResult_ImpactPoint' has a wrong offset!");
static_assert(offsetof(GA_Throw_HeldObject_C_HitValidSocket, CallFunc_BreakHitResult_Normal) == 0x0000AC, "Member 'GA_Throw_HeldObject_C_HitValidSocket::CallFunc_BreakHitResult_Normal' has a wrong offset!");
static_assert(offsetof(GA_Throw_HeldObject_C_HitValidSocket, CallFunc_BreakHitResult_ImpactNormal) == 0x0000B8, "Member 'GA_Throw_HeldObject_C_HitValidSocket::CallFunc_BreakHitResult_ImpactNormal' has a wrong offset!");
...
public:
	...
	TArray<struct FVector>                        CallFunc_CalculateProjectileTrajectorySplineWithHit_OutSplinePoints; // 0x0168(0x0010)(ReferenceParm)
	TArray<struct FVector>                        CallFunc_CalculateProjectileTrajectorySplineWithHit_OutSplineTangents; // 0x0178(0x0010)(ReferenceParm)
};
...
static_assert(sizeof(GA_Throw_HeldObject_C_GetProjectileTrajectoryPoints) == 0x000188, "Wrong size on GA_Throw_HeldObject_C_GetProjectileTrajectoryPoints");
...
static_assert(offsetof(GA_Throw_HeldObject_C_GetProjectileTrajectoryPoints, CallFunc_GetOwningPlayer_Player_Pawn) == 0x0000A8, "Member 'GA_Throw_HeldObject_C_GetProjectileTrajectoryPoints::CallFunc_GetOwningPlayer_Player_Pawn' has a wrong offset!");
static_assert(offsetof(GA_Throw_HeldObject_C_GetProjectileTrajectoryPoints, CallFunc_GetSpawnLocationAndRotation_Location) == 0x0000B0, "Member 'GA_Throw_HeldObject_C_GetProjectileTrajectoryPoints::CallFunc_GetSpawnLocationAndRotation_Location' has a wrong offset!");
static_assert(offsetof(GA_Throw_HeldObject_C_GetProjectileTrajectoryPoints, CallFunc_GetSpawnLocationAndRotation_Rotation) == 0x0000BC, "Member 'GA_Throw_HeldObject_C_GetProjectileTrajectoryPoints::CallFunc_GetSpawnLocationAndRotation_Rotation' has a wrong offset!");
static_assert(offsetof(GA_Throw_HeldObject_C_GetProjectileTrajectoryPoints, CallFunc_Conv_RotatorToVector_ReturnValue) == 0x0000C8, "Member 'GA_Throw_HeldObject_C_GetProjectileTrajectoryPoints::CallFunc_Conv_RotatorToVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_Throw_HeldObject_C_GetProjectileTrajectoryPoints, CallFunc_Multiply_VectorFloat_ReturnValue) == 0x0000D4, "Member 'GA_Throw_HeldObject_C_GetProjectileTrajectoryPoints::CallFunc_Multiply_VectorFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_Throw_HeldObject_C_GetProjectileTrajectoryPoints, CallFunc_CalculateProjectileTrajectorySplineWithHit_OutHitResult) == 0x0000E0, "Member 'GA_Throw_HeldObject_C_GetProjectileTrajectoryPoints::CallFunc_CalculateProjectileTrajectorySplineWithHit_OutHitResult' has a wrong offset!");
static_assert(offsetof(GA_Throw_HeldObject_C_GetProjectileTrajectoryPoints, CallFunc_CalculateProjectileTrajectorySplineWithHit_OutSplinePoints) == 0x000168, "Member 'GA_Throw_HeldObject_C_GetProjectileTrajectoryPoints::CallFunc_CalculateProjectileTrajectorySplineWithHit_OutSplinePoints' has a wrong offset!");
static_assert(offsetof(GA_Throw_HeldObject_C_GetProjectileTrajectoryPoints, CallFunc_CalculateProjectileTrajectorySplineWithHit_OutSplineTangents) == 0x000178, "Member 'GA_Throw_HeldObject_C_GetProjectileTrajectoryPoints::CallFunc_CalculateProjectileTrajectorySplineWithHit_OutSplineTangents' has a wrong offset!");
