...
static_assert(offsetof(UMiniShieldPotion_Prop_AnimBP_C, AnimGraphNode_Root) == 0x0002C8, "Member 'UMiniShieldPotion_Prop_AnimBP_C::AnimGraphNode_Root' has a wrong offset!");
static_assert(offsetof(UMiniShieldPotion_Prop_AnimBP_C, AnimGraphNode_Slot) == 0x0002F8, "Member 'UMiniShieldPotion_Prop_AnimBP_C::AnimGraphNode_Slot' has a wrong offset!");
static_assert(offsetof(UMiniShieldPotion_Prop_AnimBP_C, AnimGraphNode_SequenceEvaluator) == 0x000340, "Member 'UMiniShieldPotion_Prop_AnimBP_C::AnimGraphNode_SequenceEvaluator' has a wrong offset!");
