...
static_assert(sizeof(FFortAthenaLivingWorldCategory) == 0x000088, "Wrong size on FFortAthenaLivingWorldCategory");
...
static_assert(offsetof(FFortAthenaLivingWorldCategory, RequirePlaylistTagQuery) == 0x000040, "Member 'FFortAthenaLivingWorldCategory::RequirePlaylistTagQuery' has a wrong offset!");
...
static_assert(sizeof(FFortAthenaLivingWorldDensityGrid) == 0x000148, "Wrong size on FFortAthenaLivingWorldDensityGrid");
...
static_assert(sizeof(FFortAthenaLivingWorldEventDataActorSpawnDescription) == 0x0000F8, "Wrong size on FFortAthenaLivingWorldEventDataActorSpawnDescription");
