...
public:
	...
	int32                                         CurrentNumLoops;                                   // 0x0484(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	TScriptInterface<class IMovieScenePlaybackClient> PlaybackClient;                                    // 0x0600(0x0010)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMovieSceneSequencePlayer) == 0x0006A0, "Wrong size on UMovieSceneSequencePlayer");
...
static_assert(offsetof(UMovieSceneSequencePlayer, DurationSubFrames) == 0x000480, "Member 'UMovieSceneSequencePlayer::DurationSubFrames' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, CurrentNumLoops) == 0x000484, "Member 'UMovieSceneSequencePlayer::CurrentNumLoops' has a wrong offset!");
...
static_assert(offsetof(UMovieSceneSequencePlayer, NetSyncProps) == 0x0005F0, "Member 'UMovieSceneSequencePlayer::NetSyncProps' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, PlaybackClient) == 0x000600, "Member 'UMovieSceneSequencePlayer::PlaybackClient' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, TickManager) == 0x000610, "Member 'UMovieSceneSequencePlayer::TickManager' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_370[0x120];                                    // 0x0370(0x0120)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieSceneEntitySystemLinker) == 0x000490, "Wrong size on UMovieSceneEntitySystemLinker");
