...
public:
	...
	struct FScalableFloat                         HidingEnabled;                                     // 0x0A78(0x0028)(Edit, BlueprintVisible, DisableEditOnInstance)
...
static_assert(offsetof(UGA_Athena_HidingProp_LandedOn_C, UberGraphFrame) == 0x000A70, "Member 'UGA_Athena_HidingProp_LandedOn_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_Athena_HidingProp_LandedOn_C, HidingEnabled) == 0x000A78, "Member 'UGA_Athena_HidingProp_LandedOn_C::HidingEnabled' has a wrong offset!");
