...
DECLARE_LOG_CATEGORY_OFFSET(LogFortQuest, Log, All)
#define LogFortQuest UE_LOG_CATEGORY_AT(LogFortQuest, 0x93CAD18)
DECLARE_LOG_CATEGORY_OFFSET(LogLivingWorldManager, Log, All)
#define LogLivingWorldManager UE_LOG_CATEGORY_AT(LogLivingWorldManager, 0x93ACAB0)
...
DECLARE_LOG_CATEGORY_OFFSET(LogAthenaBots, Log, All)
#define LogAthenaBots UE_LOG_CATEGORY_AT(LogAthenaBots, 0x93C7360)
DECLARE_LOG_CATEGORY_OFFSET(LogAISpawnerData, Log, All)
#define LogAISpawnerData UE_LOG_CATEGORY_AT(LogAISpawnerData, 0x93C64B0)
