...
{
public:
	TArray<class FString>                         ActiveStates;                                      // 0x00B0(0x0010)(Net, ZeroConstructor, RepNotify, NativeAccessSpecifierPrivate)
...
public:
	...
	TArray<struct FVUIRuntimeMapping>             RuntimeMapping;                                    // 0x0228(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
	TArray<struct FVUIRuntimeEventMapping>        RuntimeFunctionMapping;                            // 0x0238(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
	TArray<struct FVUIRuntimeInputMapping>        RuntimeInputMapping;                               // 0x0248(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
...
{
public:
	TArray<struct FVUIDynamicEventBindingData>    EventBindings;                                     // 0x0028(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
