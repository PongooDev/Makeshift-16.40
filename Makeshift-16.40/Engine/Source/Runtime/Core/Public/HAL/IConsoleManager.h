...
class FConsoleCommandWithWorldDelegate;
...
class FConsoleCommandWithWorldArgsAndOutputDeviceDelegate;

/** Console command delegate type with the output device passed through. */
class FConsoleCommandWithOutputDeviceDelegate;
