...
public:
	...
	float                                         ActorDensityComputationRadius;                     // 0x0004(0x0004)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FortAthenaLivingWorldPointProviderInterface_GetValidLocation) == 0x000024, "Wrong size on FortAthenaLivingWorldPointProviderInterface_GetValidLocation");
...
static_assert(offsetof(FortAthenaLivingWorldPointProviderInterface_GetValidLocation, ActorDensityComputationRadius) == 0x000004, "Member 'FortAthenaLivingWorldPointProviderInterface_GetValidLocation::ActorDensityComputationRadius' has a wrong offset!");
static_assert(offsetof(FortAthenaLivingWorldPointProviderInterface_GetValidLocation, OutPosition) == 0x000008, "Member 'FortAthenaLivingWorldPointProviderInterface_GetValidLocation::OutPosition' has a wrong offset!");
static_assert(offsetof(FortAthenaLivingWorldPointProviderInterface_GetValidLocation, OutRotation) == 0x000014, "Member 'FortAthenaLivingWorldPointProviderInterface_GetValidLocation::OutRotation' has a wrong offset!");
static_assert(offsetof(FortAthenaLivingWorldPointProviderInterface_GetValidLocation, ReturnValue) == 0x000020, "Member 'FortAthenaLivingWorldPointProviderInterface_GetValidLocation::ReturnValue' has a wrong offset!");
...
// 0x0008 (0x0008 - 0x0000)
struct FortAthenaLivingWorldVolume_OnSpawnedActorDestroyed final
{
public:
	class AActor*                                 DestroyedActor;                                    // 0x0000(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FortAthenaLivingWorldVolume_OnSpawnedActorDestroyed) == 0x000008, "Wrong alignment on FortAthenaLivingWorldVolume_OnSpawnedActorDestroyed");
static_assert(sizeof(FortAthenaLivingWorldVolume_OnSpawnedActorDestroyed) == 0x000008, "Wrong size on FortAthenaLivingWorldVolume_OnSpawnedActorDestroyed");
static_assert(offsetof(FortAthenaLivingWorldVolume_OnSpawnedActorDestroyed, DestroyedActor) == 0x000000, "Member 'FortAthenaLivingWorldVolume_OnSpawnedActorDestroyed::DestroyedActor' has a wrong offset!");
