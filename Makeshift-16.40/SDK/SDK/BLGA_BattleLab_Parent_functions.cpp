...
void ABLGA_BattleLab_Parent_C::BndEvt__FortProjectileMovement_K2Node_ComponentBoundEvent_9_OnProjectileVelocityReplicated__DelegateSignature(const struct FVector& ReplicatedVelocity)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BLGA_BattleLab_Parent_C", "BndEvt__FortProjectileMovement_K2Node_ComponentBoundEvent_9_OnProjectileVelocityReplicated__DelegateSignature");

	Params::BLGA_BattleLab_Parent_C_BndEvt__FortProjectileMovement_K2Node_ComponentBoundEvent_9_OnProjectileVelocityReplicated__DelegateSignature Parms{};
...
void ABLGA_BattleLab_Parent_C::EnableElectricityPropagation()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BLGA_BattleLab_Parent_C", "EnableElectricityPropagation");
...
void ABLGA_BattleLab_Parent_C::DisableElectricityPropagation()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BLGA_BattleLab_Parent_C", "DisableElectricityPropagation");
