...
static_assert(sizeof(UMeshConnection) == 0x003030, "Wrong size on UMeshConnection");
...
static_assert(sizeof(UMeshNetDriver) == 0x0007D0, "Wrong size on UMeshNetDriver");
...
{
public:
	class UReplicationGraphNode_ActorList*        AlwaysRelevantNode;                                // 0x0528(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMeshReplicationGraph) == 0x000530, "Wrong size on UMeshReplicationGraph");
static_assert(offsetof(UMeshReplicationGraph, AlwaysRelevantNode) == 0x000528, "Member 'UMeshReplicationGraph::AlwaysRelevantNode' has a wrong offset!");
