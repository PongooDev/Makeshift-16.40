...
public:
	...
	class AFortPlayerPawnAthena*                  OwningPawn;                                        // 0x0A78(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UAnimMontage*                           ExitMontage;                                       // 0x0A80(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FScalableFloat                         LaunchHeightValue;                                 // 0x0A88(0x0028)(Edit, BlueprintVisible, DisableEditOnInstance)
...
static_assert(offsetof(UGA_WilliePete_PlayerLaunch_C, UberGraphFrame) == 0x000A70, "Member 'UGA_WilliePete_PlayerLaunch_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_WilliePete_PlayerLaunch_C, OwningPawn) == 0x000A78, "Member 'UGA_WilliePete_PlayerLaunch_C::OwningPawn' has a wrong offset!");
static_assert(offsetof(UGA_WilliePete_PlayerLaunch_C, ExitMontage) == 0x000A80, "Member 'UGA_WilliePete_PlayerLaunch_C::ExitMontage' has a wrong offset!");
static_assert(offsetof(UGA_WilliePete_PlayerLaunch_C, LaunchHeightValue) == 0x000A88, "Member 'UGA_WilliePete_PlayerLaunch_C::LaunchHeightValue' has a wrong offset!");
