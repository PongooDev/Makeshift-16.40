...
static_assert(sizeof(FDagwoodInternal) == 0x0000E8, "Wrong size on FDagwoodInternal");
...
{
public:
	struct FDagwoodInternal                       internal;                                          // 0x0000(0x00E8)(NativeAccessSpecifierPublic)
	struct FDagwoodOutPersistent                  OutPersistent;                                     // 0x00E8(0x0028)(NativeAccessSpecifierPublic)
	struct FDagwoodOutContinuous                  OutContinuous;                                     // 0x0110(0x0038)(NativeAccessSpecifierPublic)
	bool                                          bOutValid;                                         // 0x0148(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FDagwoodState_PT) == 0x000150, "Wrong size on FDagwoodState_PT");
static_assert(offsetof(FDagwoodState_PT, internal) == 0x000000, "Member 'FDagwoodState_PT::internal' has a wrong offset!");
static_assert(offsetof(FDagwoodState_PT, OutPersistent) == 0x0000E8, "Member 'FDagwoodState_PT::OutPersistent' has a wrong offset!");
static_assert(offsetof(FDagwoodState_PT, OutContinuous) == 0x000110, "Member 'FDagwoodState_PT::OutContinuous' has a wrong offset!");
static_assert(offsetof(FDagwoodState_PT, bOutValid) == 0x000148, "Member 'FDagwoodState_PT::bOutValid' has a wrong offset!");
...
public:
	...
	float                                         GravityMultiplier;                                 // 0x003C(0x0004)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxInclineAngle;                                   // 0x0040(0x0004)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxTiltAngle;                                      // 0x0044(0x0004)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FRuntimeGearInfo>               GearInfos;                                         // 0x0048(0x0010)(BlueprintVisible, ZeroConstructor, Transient, NativeAccessSpecifierPublic)
	struct FGameplayTag                           TireModTag;                                        // 0x0058(0x0008)(BlueprintVisible, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         TireModVersion;                                    // 0x0060(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         DataVersion;                                       // 0x0061(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_62[0x6];                                       // 0x0062(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FDagwoodRuntimeModifiers) == 0x000008, "Wrong alignment on FDagwoodRuntimeModifiers");
static_assert(sizeof(FDagwoodRuntimeModifiers) == 0x000068, "Wrong size on FDagwoodRuntimeModifiers");
...
static_assert(offsetof(FDagwoodRuntimeModifiers, GravityMultiplier) == 0x00003C, "Member 'FDagwoodRuntimeModifiers::GravityMultiplier' has a wrong offset!");
static_assert(offsetof(FDagwoodRuntimeModifiers, MaxInclineAngle) == 0x000040, "Member 'FDagwoodRuntimeModifiers::MaxInclineAngle' has a wrong offset!");
static_assert(offsetof(FDagwoodRuntimeModifiers, MaxTiltAngle) == 0x000044, "Member 'FDagwoodRuntimeModifiers::MaxTiltAngle' has a wrong offset!");
static_assert(offsetof(FDagwoodRuntimeModifiers, GearInfos) == 0x000048, "Member 'FDagwoodRuntimeModifiers::GearInfos' has a wrong offset!");
static_assert(offsetof(FDagwoodRuntimeModifiers, TireModTag) == 0x000058, "Member 'FDagwoodRuntimeModifiers::TireModTag' has a wrong offset!");
static_assert(offsetof(FDagwoodRuntimeModifiers, TireModVersion) == 0x000060, "Member 'FDagwoodRuntimeModifiers::TireModVersion' has a wrong offset!");
static_assert(offsetof(FDagwoodRuntimeModifiers, DataVersion) == 0x000061, "Member 'FDagwoodRuntimeModifiers::DataVersion' has a wrong offset!");
...
{
public:
	class UFortDagwoodVehicleConfigs*             FortDagwoodVehicleConfigs;                         // 0x0138(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FDagwoodRuntimeModifiers               DagwoodRuntimeModifiedProperties;                  // 0x0140(0x0068)(NativeAccessSpecifierPublic)
	TArray<ETireStates>                           TireStates;                                        // 0x01A8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_1B8[0x48];                                     // 0x01B8(0x0048)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FDagwoodInPersistent) == 0x000008, "Wrong alignment on FDagwoodInPersistent");
static_assert(sizeof(FDagwoodInPersistent) == 0x000200, "Wrong size on FDagwoodInPersistent");
static_assert(offsetof(FDagwoodInPersistent, FortDagwoodVehicleConfigs) == 0x000138, "Member 'FDagwoodInPersistent::FortDagwoodVehicleConfigs' has a wrong offset!");
static_assert(offsetof(FDagwoodInPersistent, DagwoodRuntimeModifiedProperties) == 0x000140, "Member 'FDagwoodInPersistent::DagwoodRuntimeModifiedProperties' has a wrong offset!");
static_assert(offsetof(FDagwoodInPersistent, TireStates) == 0x0001A8, "Member 'FDagwoodInPersistent::TireStates' has a wrong offset!");
...
public:
	...
	struct FDagwoodInPersistent                   GT_State;                                          // 0x0020(0x0200)(NativeAccessSpecifierPublic)
	struct FDagwoodState_PT                       PT_State;                                          // 0x0220(0x0150)(NativeAccessSpecifierPublic)
	class APlayerController*                      PC;                                                // 0x0370(0x0008)(ZeroConstructor, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FDagwoodManagedState) == 0x000380, "Wrong size on FDagwoodManagedState");
...
static_assert(offsetof(FDagwoodManagedState, PT_State) == 0x000220, "Member 'FDagwoodManagedState::PT_State' has a wrong offset!");
static_assert(offsetof(FDagwoodManagedState, PC) == 0x000370, "Member 'FDagwoodManagedState::PC' has a wrong offset!");
...
static_assert(sizeof(FTireInfo) == 0x000198, "Wrong size on FTireInfo");
