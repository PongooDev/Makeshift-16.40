...
public:
	...
	TSubclassOf<class UCommonButtonLegacy>        TabButtonType;                                     // 0x00B0(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                         Pad_89[0x37];                                      // 0x0089(0x0037)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAthenaMOTDBase) == 0x000008, "Wrong alignment on FAthenaMOTDBase");
static_assert(sizeof(FAthenaMOTDBase) == 0x0000C0, "Wrong size on FAthenaMOTDBase");
...
static_assert(sizeof(FSettingsMOTD) == 0x0000E0, "Wrong size on FSettingsMOTD");
...
{
public:
	struct FFortPlayerSurveyLocalizableText       QuestionText;                                      // 0x0000(0x0020)(NativeAccessSpecifierPublic)
...
static_assert(sizeof(FChallengeMOTD) == 0x0000D0, "Wrong size on FChallengeMOTD");
...
static_assert(sizeof(FWebsiteMOTD) == 0x0000E0, "Wrong size on FWebsiteMOTD");
...
static_assert(sizeof(FSpatialScreenMOTD) == 0x0000D0, "Wrong size on FSpatialScreenMOTD");
...
static_assert(sizeof(FPlaylistMOTD) == 0x0000D0, "Wrong size on FPlaylistMOTD");
...
static_assert(sizeof(FNavigateToTabMOTD) == 0x0000D8, "Wrong size on FNavigateToTabMOTD");
...
static_assert(sizeof(FItemMOTD) == 0x0000D8, "Wrong size on FItemMOTD");
...
static_assert(sizeof(FSmallNewsMOTD) == 0x0000C0, "Wrong size on FSmallNewsMOTD");
...
public:
	...
	TArray<struct FAthenaCrewPackItem>            CrewPackItems;                                     // 0x00E8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FAthenaSubscriptionPurchaseDetails     PurchaseSubscriptionDetails;                       // 0x01F0(0x00A8)(NativeAccessSpecifierPublic)
	class FText                                   SubscriptionDisclaimer;                            // 0x0298(0x0018)(NativeAccessSpecifierPublic)
	class FText                                   BlockedBenefitsNotice;                             // 0x02B0(0x0018)(NativeAccessSpecifierPublic)
	struct FSubscriptionModals                    SubModals;                                         // 0x02C8(0x0010)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FAthenaSubscriptionInfo) == 0x000008, "Wrong alignment on FAthenaSubscriptionInfo");
static_assert(sizeof(FAthenaSubscriptionInfo) == 0x0002D8, "Wrong size on FAthenaSubscriptionInfo");
...
static_assert(offsetof(FAthenaSubscriptionInfo, SubscriptionDisclaimer) == 0x000298, "Member 'FAthenaSubscriptionInfo::SubscriptionDisclaimer' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionInfo, BlockedBenefitsNotice) == 0x0002B0, "Member 'FAthenaSubscriptionInfo::BlockedBenefitsNotice' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionInfo, SubModals) == 0x0002C8, "Member 'FAthenaSubscriptionInfo::SubModals' has a wrong offset!");
...
{
public:
	EMcpSubscriptionState                         SubscriptionState;                                 // 0x00F8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_F9[0x17];                                      // 0x00F9(0x0017)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   SkinDescription;                                   // 0x0110(0x0018)(NativeAccessSpecifierPublic)
	class FText                                   MtxDescription;                                    // 0x0128(0x0018)(NativeAccessSpecifierPublic)
	bool                                          bUsingNextSkin;                                    // 0x0140(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUsingNextBattlepassImage;                         // 0x0141(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUsingNextBattlepassTexts;                         // 0x0142(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUsingNextSkinTileImage;                           // 0x0143(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FAthenaSubscriptionExpectedRewards) == 0x000148, "Wrong size on FAthenaSubscriptionExpectedRewards");
static_assert(offsetof(FAthenaSubscriptionExpectedRewards, SubscriptionState) == 0x0000F8, "Member 'FAthenaSubscriptionExpectedRewards::SubscriptionState' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionExpectedRewards, SkinDescription) == 0x000110, "Member 'FAthenaSubscriptionExpectedRewards::SkinDescription' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionExpectedRewards, MtxDescription) == 0x000128, "Member 'FAthenaSubscriptionExpectedRewards::MtxDescription' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionExpectedRewards, bUsingNextSkin) == 0x000140, "Member 'FAthenaSubscriptionExpectedRewards::bUsingNextSkin' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionExpectedRewards, bUsingNextBattlepassImage) == 0x000141, "Member 'FAthenaSubscriptionExpectedRewards::bUsingNextBattlepassImage' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionExpectedRewards, bUsingNextBattlepassTexts) == 0x000142, "Member 'FAthenaSubscriptionExpectedRewards::bUsingNextBattlepassTexts' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionExpectedRewards, bUsingNextSkinTileImage) == 0x000143, "Member 'FAthenaSubscriptionExpectedRewards::bUsingNextSkinTileImage' has a wrong offset!");
...
static_assert(sizeof(FVideoWidgetConfig) == 0x000040, "Wrong size on FVideoWidgetConfig");
...
public:
	...
	TArray<struct FVaultVariantOverrideOption>    VariantOverrides;                                  // 0x0040(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FFortPlayerSurveyCMSData) == 0x000048, "Wrong size on FFortPlayerSurveyCMSData");
...
static_assert(offsetof(FFortPlayerSurveyCMSData, Surveys) == 0x000030, "Member 'FFortPlayerSurveyCMSData::Surveys' has a wrong offset!");
static_assert(offsetof(FFortPlayerSurveyCMSData, bSurveysEnabled) == 0x000040, "Member 'FFortPlayerSurveyCMSData::bSurveysEnabled' has a wrong offset!");
...
static_assert(alignof(FForcedIntroEntry) == 0x000008, "Wrong alignment on FForcedIntroEntry");
static_assert(sizeof(FForcedIntroEntry) == 0x000030, "Wrong size on FForcedIntroEntry");
static_assert(offsetof(FForcedIntroEntry, EntryName) == 0x000000, "Member 'FForcedIntroEntry::EntryName' has a wrong offset!");
static_assert(offsetof(FForcedIntroEntry, WidgetClass) == 0x000008, "Member 'FForcedIntroEntry::WidgetClass' has a wrong offset!");
