...
static_assert(sizeof(UGA_SlamDoorOpen_Instigator_C) == 0x000A78, "Wrong size on UGA_SlamDoorOpen_Instigator_C");
static_assert(offsetof(UGA_SlamDoorOpen_Instigator_C, UberGraphFrame) == 0x000A70, "Member 'UGA_SlamDoorOpen_Instigator_C::UberGraphFrame' has a wrong offset!");
