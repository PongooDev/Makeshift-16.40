...
public:
	...
	class ANPC_Pawn_Parent_C*                     K2Node_DynamicCast_AsNPC_Pawn_Parent;              // 0x0018(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	...
	bool                                          CallFunc_NPC_TargetSlotInfo_TargetSlotsMaxOrMore;  // 0x003C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_NPC_TargetSlotInfo_TargetSlotCountIsExactlyMax; // 0x003D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_NPC_TargetSlotInfo_NPC_IsTargetSlotOwner; // 0x003E(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_NPC_TargetSlotInfo_NPC_HasSpaceToSlotOnTarget; // 0x003F(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
