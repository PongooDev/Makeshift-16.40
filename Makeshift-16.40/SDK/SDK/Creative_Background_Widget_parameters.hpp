...
static_assert(sizeof(Creative_Background_Widget_C_SetTextScale) == 0x000060, "Wrong size on Creative_Background_Widget_C_SetTextScale");
...
static_assert(sizeof(Creative_Background_Widget_C_SetTextFont) == 0x000128, "Wrong size on Creative_Background_Widget_C_SetTextFont");
...
static_assert(offsetof(Creative_Background_Widget_C_SetTextFont, Temp_int_Variable) == 0x000060, "Member 'Creative_Background_Widget_C_SetTextFont::Temp_int_Variable' has a wrong offset!");
static_assert(offsetof(Creative_Background_Widget_C_SetTextFont, K2Node_MakeStruct_FontOutlineSettings) == 0x000068, "Member 'Creative_Background_Widget_C_SetTextFont::K2Node_MakeStruct_FontOutlineSettings' has a wrong offset!");
static_assert(offsetof(Creative_Background_Widget_C_SetTextFont, Temp_name_Variable) == 0x000088, "Member 'Creative_Background_Widget_C_SetTextFont::Temp_name_Variable' has a wrong offset!");
static_assert(offsetof(Creative_Background_Widget_C_SetTextFont, Temp_name_Variable_1) == 0x000090, "Member 'Creative_Background_Widget_C_SetTextFont::Temp_name_Variable_1' has a wrong offset!");
static_assert(offsetof(Creative_Background_Widget_C_SetTextFont, Temp_name_Variable_2) == 0x000098, "Member 'Creative_Background_Widget_C_SetTextFont::Temp_name_Variable_2' has a wrong offset!");
static_assert(offsetof(Creative_Background_Widget_C_SetTextFont, Temp_int_Variable_1) == 0x0000A0, "Member 'Creative_Background_Widget_C_SetTextFont::Temp_int_Variable_1' has a wrong offset!");
static_assert(offsetof(Creative_Background_Widget_C_SetTextFont, K2Node_Select_Default) == 0x0000A4, "Member 'Creative_Background_Widget_C_SetTextFont::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(Creative_Background_Widget_C_SetTextFont, Temp_object_Variable) == 0x0000B0, "Member 'Creative_Background_Widget_C_SetTextFont::Temp_object_Variable' has a wrong offset!");
static_assert(offsetof(Creative_Background_Widget_C_SetTextFont, Temp_object_Variable_1) == 0x0000B8, "Member 'Creative_Background_Widget_C_SetTextFont::Temp_object_Variable_1' has a wrong offset!");
static_assert(offsetof(Creative_Background_Widget_C_SetTextFont, Temp_object_Variable_2) == 0x0000C0, "Member 'Creative_Background_Widget_C_SetTextFont::Temp_object_Variable_2' has a wrong offset!");
static_assert(offsetof(Creative_Background_Widget_C_SetTextFont, K2Node_Select_Default_1) == 0x0000C8, "Member 'Creative_Background_Widget_C_SetTextFont::K2Node_Select_Default_1' has a wrong offset!");
static_assert(offsetof(Creative_Background_Widget_C_SetTextFont, K2Node_MakeStruct_SlateFontInfo) == 0x0000D0, "Member 'Creative_Background_Widget_C_SetTextFont::K2Node_MakeStruct_SlateFontInfo' has a wrong offset!");
