...
void AFortDagwoodVehicle::ApplyTireMod(const struct FGameplayTag& NewTireModTag, TSubclassOf<class UGameplayEffect> GameplayEffect, const class AFortPlayerController* EventInstigator)
{
