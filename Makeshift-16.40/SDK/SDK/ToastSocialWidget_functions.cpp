...
ESlateVisibility UToastSocialWidget_C::GetOpenButtonVisibility()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ToastSocialWidget_C", "GetOpenButtonVisibility");

	Params::ToastSocialWidget_C_GetOpenButtonVisibility Parms{};
...
// Function ToastSocialWidget.ToastSocialWidget_C.OnBeginCloseNotification
// (Event, Protected, BlueprintEvent)

void UToastSocialWidget_C::OnBeginCloseNotification()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ToastSocialWidget_C", "OnBeginCloseNotification");
