...
public:
	...
	float                                         Horn_Pitch_Down_Horn_Volume_B99C94784317A4FD1CDE56857EF15DC1; // 0x02C0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	float                                         Horn_Pitch_Down_Horn_Pitch_B99C94784317A4FD1CDE56857EF15DC1; // 0x02C4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	...
	class UTimelineComponent*                     Horn_Pitch_Down;                                   // 0x02D0(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	...
	struct FVector                                HoagieLocationOffset;                              // 0x0308(0x000C)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         DotProductOffset;                                  // 0x0314(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         DotProductOffsetMin;                               // 0x0318(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         DotProductOffsetMax;                               // 0x031C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CurrentDotProduct;                                 // 0x0320(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_324[0x4];                                      // 0x0324(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class USoundBase*                             DestroySound;                                      // 0x0328(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          IsLocalPlayerInVehicle;                            // 0x0330(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	uint8                                         Pad_331[0x7];                                      // 0x0331(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<float>                                 DamageThresholds;                                  // 0x0338(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance)
	bool                                          CriticalDamage;                                    // 0x0348(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	bool                                          RotorHit;                                          // 0x0349(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	uint8                                         Pad_34A[0x6];                                      // 0x034A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class USoundBase*                             DamageState1;                                      // 0x0350(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class USoundBase*                             DamageState2;                                      // 0x0358(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class USoundBase*                             DamageState3;                                      // 0x0360(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          HighQualityOverride;                               // 0x0368(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	bool                                          HasInitialized;                                    // 0x0369(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)

public:
	void ExecuteUbergraph_BP_Hoagie_AudioController(int32 EntryPoint);
	void Cache_References(class AHoagieVehicle_C* Vehicle_0);
	void On_Update_Audio(class AHoagieVehicle_C* HoagieVehicle_0);
...
static_assert(sizeof(ABP_Hoagie_AudioController_C) == 0x000370, "Wrong size on ABP_Hoagie_AudioController_C");
...
static_assert(offsetof(ABP_Hoagie_AudioController_C, HoagieLocationOffset) == 0x000308, "Member 'ABP_Hoagie_AudioController_C::HoagieLocationOffset' has a wrong offset!");
static_assert(offsetof(ABP_Hoagie_AudioController_C, DotProductOffset) == 0x000314, "Member 'ABP_Hoagie_AudioController_C::DotProductOffset' has a wrong offset!");
static_assert(offsetof(ABP_Hoagie_AudioController_C, DotProductOffsetMin) == 0x000318, "Member 'ABP_Hoagie_AudioController_C::DotProductOffsetMin' has a wrong offset!");
static_assert(offsetof(ABP_Hoagie_AudioController_C, DotProductOffsetMax) == 0x00031C, "Member 'ABP_Hoagie_AudioController_C::DotProductOffsetMax' has a wrong offset!");
static_assert(offsetof(ABP_Hoagie_AudioController_C, CurrentDotProduct) == 0x000320, "Member 'ABP_Hoagie_AudioController_C::CurrentDotProduct' has a wrong offset!");
static_assert(offsetof(ABP_Hoagie_AudioController_C, DestroySound) == 0x000328, "Member 'ABP_Hoagie_AudioController_C::DestroySound' has a wrong offset!");
static_assert(offsetof(ABP_Hoagie_AudioController_C, IsLocalPlayerInVehicle) == 0x000330, "Member 'ABP_Hoagie_AudioController_C::IsLocalPlayerInVehicle' has a wrong offset!");
static_assert(offsetof(ABP_Hoagie_AudioController_C, DamageThresholds) == 0x000338, "Member 'ABP_Hoagie_AudioController_C::DamageThresholds' has a wrong offset!");
static_assert(offsetof(ABP_Hoagie_AudioController_C, CriticalDamage) == 0x000348, "Member 'ABP_Hoagie_AudioController_C::CriticalDamage' has a wrong offset!");
static_assert(offsetof(ABP_Hoagie_AudioController_C, RotorHit) == 0x000349, "Member 'ABP_Hoagie_AudioController_C::RotorHit' has a wrong offset!");
static_assert(offsetof(ABP_Hoagie_AudioController_C, DamageState1) == 0x000350, "Member 'ABP_Hoagie_AudioController_C::DamageState1' has a wrong offset!");
static_assert(offsetof(ABP_Hoagie_AudioController_C, DamageState2) == 0x000358, "Member 'ABP_Hoagie_AudioController_C::DamageState2' has a wrong offset!");
static_assert(offsetof(ABP_Hoagie_AudioController_C, DamageState3) == 0x000360, "Member 'ABP_Hoagie_AudioController_C::DamageState3' has a wrong offset!");
static_assert(offsetof(ABP_Hoagie_AudioController_C, HighQualityOverride) == 0x000368, "Member 'ABP_Hoagie_AudioController_C::HighQualityOverride' has a wrong offset!");
static_assert(offsetof(ABP_Hoagie_AudioController_C, HasInitialized) == 0x000369, "Member 'ABP_Hoagie_AudioController_C::HasInitialized' has a wrong offset!");
