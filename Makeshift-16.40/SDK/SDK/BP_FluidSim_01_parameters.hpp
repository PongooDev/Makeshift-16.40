...
public:
	...
	TArray<class UMaterialInterface*>             CallFunc_Map_Keys_Keys;                            // 0x0030(0x0010)(ReferenceParm)
	...
	class UMaterialInstanceDynamic*               CallFunc_Get_Force_MID_MID;                        // 0x0058(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_EqualEqual_ObjectObject_ReturnValue_1;    // 0x0086(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(offsetof(BP_FluidSim_01_C_SetupSimMIDs, Temp_int_Loop_Counter_Variable) == 0x00000C, "Member 'BP_FluidSim_01_C_SetupSimMIDs::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(BP_FluidSim_01_C_SetupSimMIDs, CallFunc_Add_IntInt_ReturnValue) == 0x000010, "Member 'BP_FluidSim_01_C_SetupSimMIDs::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FluidSim_01_C_SetupSimMIDs, Temp_int_Array_Index_Variable) == 0x000014, "Member 'BP_FluidSim_01_C_SetupSimMIDs::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(BP_FluidSim_01_C_SetupSimMIDs, Temp_object_Variable_1) == 0x000018, "Member 'BP_FluidSim_01_C_SetupSimMIDs::Temp_object_Variable_1' has a wrong offset!");
static_assert(offsetof(BP_FluidSim_01_C_SetupSimMIDs, CallFunc_IsValid_ReturnValue_1) == 0x000020, "Member 'BP_FluidSim_01_C_SetupSimMIDs::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_FluidSim_01_C_SetupSimMIDs, CallFunc_EqualEqual_ObjectObject_ReturnValue) == 0x000021, "Member 'BP_FluidSim_01_C_SetupSimMIDs::CallFunc_EqualEqual_ObjectObject_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FluidSim_01_C_SetupSimMIDs, CallFunc_Conv_BoolToFloat_ReturnValue) == 0x000024, "Member 'BP_FluidSim_01_C_SetupSimMIDs::CallFunc_Conv_BoolToFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FluidSim_01_C_SetupSimMIDs, Temp_bool_Variable) == 0x000028, "Member 'BP_FluidSim_01_C_SetupSimMIDs::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(BP_FluidSim_01_C_SetupSimMIDs, CallFunc_Map_Keys_Keys) == 0x000030, "Member 'BP_FluidSim_01_C_SetupSimMIDs::CallFunc_Map_Keys_Keys' has a wrong offset!");
static_assert(offsetof(BP_FluidSim_01_C_SetupSimMIDs, K2Node_Select_Default) == 0x000040, "Member 'BP_FluidSim_01_C_SetupSimMIDs::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(BP_FluidSim_01_C_SetupSimMIDs, CallFunc_Array_Get_Item) == 0x000048, "Member 'BP_FluidSim_01_C_SetupSimMIDs::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(BP_FluidSim_01_C_SetupSimMIDs, CallFunc_IsValid_ReturnValue_2) == 0x000050, "Member 'BP_FluidSim_01_C_SetupSimMIDs::CallFunc_IsValid_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_FluidSim_01_C_SetupSimMIDs, CallFunc_Get_Force_MID_MID) == 0x000058, "Member 'BP_FluidSim_01_C_SetupSimMIDs::CallFunc_Get_Force_MID_MID' has a wrong offset!");
static_assert(offsetof(BP_FluidSim_01_C_SetupSimMIDs, CallFunc_CreateDynamicMaterialInstance_ReturnValue) == 0x000060, "Member 'BP_FluidSim_01_C_SetupSimMIDs::CallFunc_CreateDynamicMaterialInstance_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FluidSim_01_C_SetupSimMIDs, CallFunc_Array_Length_ReturnValue) == 0x000068, "Member 'BP_FluidSim_01_C_SetupSimMIDs::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FluidSim_01_C_SetupSimMIDs, CallFunc_CreateDynamicMaterialInstance_ReturnValue_1) == 0x000070, "Member 'BP_FluidSim_01_C_SetupSimMIDs::CallFunc_CreateDynamicMaterialInstance_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_FluidSim_01_C_SetupSimMIDs, CallFunc_Less_IntInt_ReturnValue) == 0x000078, "Member 'BP_FluidSim_01_C_SetupSimMIDs::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FluidSim_01_C_SetupSimMIDs, CallFunc_Conv_IntToFloat_ReturnValue) == 0x00007C, "Member 'BP_FluidSim_01_C_SetupSimMIDs::CallFunc_Conv_IntToFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FluidSim_01_C_SetupSimMIDs, CallFunc_Conv_IntToFloat_ReturnValue_1) == 0x000080, "Member 'BP_FluidSim_01_C_SetupSimMIDs::CallFunc_Conv_IntToFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_FluidSim_01_C_SetupSimMIDs, CallFunc_IsValid_ReturnValue_3) == 0x000084, "Member 'BP_FluidSim_01_C_SetupSimMIDs::CallFunc_IsValid_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(BP_FluidSim_01_C_SetupSimMIDs, CallFunc_IsValid_ReturnValue_4) == 0x000085, "Member 'BP_FluidSim_01_C_SetupSimMIDs::CallFunc_IsValid_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(BP_FluidSim_01_C_SetupSimMIDs, CallFunc_EqualEqual_ObjectObject_ReturnValue_1) == 0x000086, "Member 'BP_FluidSim_01_C_SetupSimMIDs::CallFunc_EqualEqual_ObjectObject_ReturnValue_1' has a wrong offset!");
...
{
public:
	TArray<class ALandscapeWaterInfo_C*>          CallFunc_GetAllActorsOfClass_OutActors;            // 0x0000(0x0010)(ReferenceParm)
...
public:
	...
	struct FFluidForceDynamicPerInstanceData      K2Node_MakeStruct_FluidForceDynamicPerInstanceData; // 0x01F8(0x0130)(ContainsInstancedReference, UObjectWrapper, HasGetValueTypeHash)
	...
	class USkeletalMeshComponent*                 K2Node_DynamicCast_AsSkeletal_Mesh_Component;      // 0x0480(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	...
	struct FFluidForceDynamicPerInstanceData      K2Node_MakeStruct_FluidForceDynamicPerInstanceData_1; // 0x0660(0x0130)(ContainsInstancedReference, UObjectWrapper, HasGetValueTypeHash)
...
public:
	...
	class USkeletalMeshComponent*                 K2Node_DynamicCast_AsSkeletal_Mesh_Component;      // 0x0290(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
...
public:
	...
	TArray<class AWaterBody*>                     CallFunc_GetAllActorsOfClass_OutActors;            // 0x0008(0x0010)(ReferenceParm)
