...
static_assert(offsetof(UCowboy_Repeater_Rifle_Rifle_Skeleton_AnimBlueprint_C, AnimGraphNode_Root) == 0x0002C8, "Member 'UCowboy_Repeater_Rifle_Rifle_Skeleton_AnimBlueprint_C::AnimGraphNode_Root' has a wrong offset!");
static_assert(offsetof(UCowboy_Repeater_Rifle_Rifle_Skeleton_AnimBlueprint_C, AnimGraphNode_Slot) == 0x0002F8, "Member 'UCowboy_Repeater_Rifle_Rifle_Skeleton_AnimBlueprint_C::AnimGraphNode_Slot' has a wrong offset!");
static_assert(offsetof(UCowboy_Repeater_Rifle_Rifle_Skeleton_AnimBlueprint_C, AnimGraphNode_SequencePlayer) == 0x000340, "Member 'UCowboy_Repeater_Rifle_Rifle_Skeleton_AnimBlueprint_C::AnimGraphNode_SequencePlayer' has a wrong offset!");
