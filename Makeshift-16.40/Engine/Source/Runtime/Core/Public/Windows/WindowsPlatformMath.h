...
#include "Engine/Source/Runtime/Core/Public/GenericPlatform/GenericPlatformMath.h"
...
#include "Engine/Source/Runtime/Core/Public/Math/UnrealPlatformMathSSE4.h"
