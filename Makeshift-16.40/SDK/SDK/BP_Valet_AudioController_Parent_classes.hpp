...
public:
	...
	class USynthComponentMoto*                    SynthComponentMoto;                                // 0x0358(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UFortCollisionAudioComponent*           CollisionAudio_HitObject;                          // 0x0360(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UAudioComponent*                        Horn;                                              // 0x0368(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UAudioComponent*                        Engine_OnOff;                                      // 0x0370(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UFortLayeredAudioComponent*             Engine;                                            // 0x0378(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UFortCollisionAudioComponent*           CollisionAudio_Suspension;                         // 0x0380(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UFortCollisionAudioComponent*           CollisionAudio_Body;                               // 0x0388(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	float                                         Moto_FadeOut_Volume_A91224EC482A9C0F90B4E198803A420B; // 0x0390(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	ETimelineDirection                            Moto_FadeOut__Direction_A91224EC482A9C0F90B4E198803A420B; // 0x0394(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_395[0x3];                                      // 0x0395(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class UTimelineComponent*                     Moto_FadeOut;                                      // 0x0398(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         Shift_Up_Alpha_93F8CCBD410A7922FEA656ACD9B2EFFB;   // 0x03A0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	ETimelineDirection                            Shift_Up__Direction_93F8CCBD410A7922FEA656ACD9B2EFFB; // 0x03A4(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_3A5[0x3];                                      // 0x03A5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class UTimelineComponent*                     Shift_Up;                                          // 0x03A8(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class USoundBase*                             CollisionBodyLightSoundCue;                        // 0x0570(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ABP_Valet_AudioController_Parent_C) == 0x000578, "Wrong size on ABP_Valet_AudioController_Parent_C");
static_assert(offsetof(ABP_Valet_AudioController_Parent_C, UberGraphFrame) == 0x000350, "Member 'ABP_Valet_AudioController_Parent_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ABP_Valet_AudioController_Parent_C, SynthComponentMoto) == 0x000358, "Member 'ABP_Valet_AudioController_Parent_C::SynthComponentMoto' has a wrong offset!");
static_assert(offsetof(ABP_Valet_AudioController_Parent_C, CollisionAudio_HitObject) == 0x000360, "Member 'ABP_Valet_AudioController_Parent_C::CollisionAudio_HitObject' has a wrong offset!");
static_assert(offsetof(ABP_Valet_AudioController_Parent_C, Horn) == 0x000368, "Member 'ABP_Valet_AudioController_Parent_C::Horn' has a wrong offset!");
static_assert(offsetof(ABP_Valet_AudioController_Parent_C, Engine_OnOff) == 0x000370, "Member 'ABP_Valet_AudioController_Parent_C::Engine_OnOff' has a wrong offset!");
static_assert(offsetof(ABP_Valet_AudioController_Parent_C, Engine) == 0x000378, "Member 'ABP_Valet_AudioController_Parent_C::Engine' has a wrong offset!");
static_assert(offsetof(ABP_Valet_AudioController_Parent_C, CollisionAudio_Suspension) == 0x000380, "Member 'ABP_Valet_AudioController_Parent_C::CollisionAudio_Suspension' has a wrong offset!");
static_assert(offsetof(ABP_Valet_AudioController_Parent_C, CollisionAudio_Body) == 0x000388, "Member 'ABP_Valet_AudioController_Parent_C::CollisionAudio_Body' has a wrong offset!");
static_assert(offsetof(ABP_Valet_AudioController_Parent_C, Moto_FadeOut_Volume_A91224EC482A9C0F90B4E198803A420B) == 0x000390, "Member 'ABP_Valet_AudioController_Parent_C::Moto_FadeOut_Volume_A91224EC482A9C0F90B4E198803A420B' has a wrong offset!");
static_assert(offsetof(ABP_Valet_AudioController_Parent_C, Moto_FadeOut__Direction_A91224EC482A9C0F90B4E198803A420B) == 0x000394, "Member 'ABP_Valet_AudioController_Parent_C::Moto_FadeOut__Direction_A91224EC482A9C0F90B4E198803A420B' has a wrong offset!");
static_assert(offsetof(ABP_Valet_AudioController_Parent_C, Moto_FadeOut) == 0x000398, "Member 'ABP_Valet_AudioController_Parent_C::Moto_FadeOut' has a wrong offset!");
static_assert(offsetof(ABP_Valet_AudioController_Parent_C, Shift_Up_Alpha_93F8CCBD410A7922FEA656ACD9B2EFFB) == 0x0003A0, "Member 'ABP_Valet_AudioController_Parent_C::Shift_Up_Alpha_93F8CCBD410A7922FEA656ACD9B2EFFB' has a wrong offset!");
static_assert(offsetof(ABP_Valet_AudioController_Parent_C, Shift_Up__Direction_93F8CCBD410A7922FEA656ACD9B2EFFB) == 0x0003A4, "Member 'ABP_Valet_AudioController_Parent_C::Shift_Up__Direction_93F8CCBD410A7922FEA656ACD9B2EFFB' has a wrong offset!");
static_assert(offsetof(ABP_Valet_AudioController_Parent_C, Shift_Up) == 0x0003A8, "Member 'ABP_Valet_AudioController_Parent_C::Shift_Up' has a wrong offset!");
...
static_assert(offsetof(ABP_Valet_AudioController_Parent_C, CollisionBodyLightSoundCue) == 0x000570, "Member 'ABP_Valet_AudioController_Parent_C::CollisionBodyLightSoundCue' has a wrong offset!");
