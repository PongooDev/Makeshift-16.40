...
static_assert(sizeof(UGA_Athena_HidingProp_HidingInProp_C) == 0x000A98, "Wrong size on UGA_Athena_HidingProp_HidingInProp_C");
static_assert(offsetof(UGA_Athena_HidingProp_HidingInProp_C, UberGraphFrame) == 0x000A70, "Member 'UGA_Athena_HidingProp_HidingInProp_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_Athena_HidingProp_HidingInProp_C, ChangeEquipmentTag) == 0x000A78, "Member 'UGA_Athena_HidingProp_HidingInProp_C::ChangeEquipmentTag' has a wrong offset!");
