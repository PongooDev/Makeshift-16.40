...
public:
	...
	class USoundBase*                             OnOptionConfirmedSound;                            // 0x0C48(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class USoundBase*                             OnOptionHoveredSound;                              // 0x0C50(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UCommonVisibilitySwitcher*              Switcher_DisplayAsset;                             // 0x0C58(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TSoftObjectPtr<class UObject>                 DefaultSoftTaskIcon;                               // 0x0C60(0x0028)(Edit, DisableEditOnInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TSoftObjectPtr<class USoundBase>              DefaultConfirmChoiceSound;                         // 0x0C88(0x0028)(Edit, DisableEditOnInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TSoftObjectPtr<class USoundBase>              DefaultHoverChoiceSound;                           // 0x0CB0(0x0028)(Edit, DisableEditOnInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortConversationOption) == 0x000CD8, "Wrong size on UFortConversationOption");
static_assert(offsetof(UFortConversationOption, OnOptionConfirmedSound) == 0x000C48, "Member 'UFortConversationOption::OnOptionConfirmedSound' has a wrong offset!");
static_assert(offsetof(UFortConversationOption, OnOptionHoveredSound) == 0x000C50, "Member 'UFortConversationOption::OnOptionHoveredSound' has a wrong offset!");
static_assert(offsetof(UFortConversationOption, Switcher_DisplayAsset) == 0x000C58, "Member 'UFortConversationOption::Switcher_DisplayAsset' has a wrong offset!");
static_assert(offsetof(UFortConversationOption, DefaultSoftTaskIcon) == 0x000C60, "Member 'UFortConversationOption::DefaultSoftTaskIcon' has a wrong offset!");
static_assert(offsetof(UFortConversationOption, DefaultConfirmChoiceSound) == 0x000C88, "Member 'UFortConversationOption::DefaultConfirmChoiceSound' has a wrong offset!");
static_assert(offsetof(UFortConversationOption, DefaultHoverChoiceSound) == 0x000CB0, "Member 'UFortConversationOption::DefaultHoverChoiceSound' has a wrong offset!");
...
public:
	...
	TArray<struct FGameplayTag>                   TagPriorities;                                     // 0x0368(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPrivate)
	...
	class UFortShowFutureStormCircleBrief*        ShowFutureStormCircleBrief_Main;                   // 0x0450(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UFortApplyAbilityBrief*                 RiftToGoBrief_Main;                                // 0x0458(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UFortApplyAbilityBrief*                 PropDisguiseBrief_Main;                            // 0x0460(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UFortBasicBrief*                        ChatBrief_Main;                                    // 0x0468(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UFortBasicBrief*                        BasicBrief_Main;                                   // 0x0470(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UFortDataDrivenServiceBrief*            DataDrivenServiceBrief_Main;                       // 0x0478(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UCommonVisibilitySwitcher*              Switcher_Details;                                  // 0x0480(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class USizeBox*                               SizeBox_RadialMenu;                                // 0x0488(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UWidget*                                Overlay_Details;                                   // 0x0490(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UWidget*                                Overlay_WheelContainer;                            // 0x0498(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UImage*                                 Image_Background;                                  // 0x04A0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UImage*                                 Image_LoadingSpinner;                              // 0x04A8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortConversationScreen) == 0x0004B8, "Wrong size on UFortConversationScreen");
...
static_assert(offsetof(UFortConversationScreen, ShowFutureStormCircleBrief_Main) == 0x000450, "Member 'UFortConversationScreen::ShowFutureStormCircleBrief_Main' has a wrong offset!");
static_assert(offsetof(UFortConversationScreen, RiftToGoBrief_Main) == 0x000458, "Member 'UFortConversationScreen::RiftToGoBrief_Main' has a wrong offset!");
static_assert(offsetof(UFortConversationScreen, PropDisguiseBrief_Main) == 0x000460, "Member 'UFortConversationScreen::PropDisguiseBrief_Main' has a wrong offset!");
static_assert(offsetof(UFortConversationScreen, ChatBrief_Main) == 0x000468, "Member 'UFortConversationScreen::ChatBrief_Main' has a wrong offset!");
static_assert(offsetof(UFortConversationScreen, BasicBrief_Main) == 0x000470, "Member 'UFortConversationScreen::BasicBrief_Main' has a wrong offset!");
static_assert(offsetof(UFortConversationScreen, DataDrivenServiceBrief_Main) == 0x000478, "Member 'UFortConversationScreen::DataDrivenServiceBrief_Main' has a wrong offset!");
static_assert(offsetof(UFortConversationScreen, Switcher_Details) == 0x000480, "Member 'UFortConversationScreen::Switcher_Details' has a wrong offset!");
static_assert(offsetof(UFortConversationScreen, SizeBox_RadialMenu) == 0x000488, "Member 'UFortConversationScreen::SizeBox_RadialMenu' has a wrong offset!");
static_assert(offsetof(UFortConversationScreen, Overlay_Details) == 0x000490, "Member 'UFortConversationScreen::Overlay_Details' has a wrong offset!");
static_assert(offsetof(UFortConversationScreen, Overlay_WheelContainer) == 0x000498, "Member 'UFortConversationScreen::Overlay_WheelContainer' has a wrong offset!");
static_assert(offsetof(UFortConversationScreen, Image_Background) == 0x0004A0, "Member 'UFortConversationScreen::Image_Background' has a wrong offset!");
static_assert(offsetof(UFortConversationScreen, Image_LoadingSpinner) == 0x0004A8, "Member 'UFortConversationScreen::Image_LoadingSpinner' has a wrong offset!");
...
{
public:
	class UCommonTextBlock*                       Text_TitleBar;                                     // 0x0288(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UCommonRichTextBlock*                   RichText_Description;                              // 0x0290(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UCommonTextBlock*                       Text_StockRemaining;                               // 0x0298(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UFortTransactionStrip*                  TransactionStrip_Main;                             // 0x02A0(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UFortDataDrivenServiceBrief) == 0x0002F8, "Wrong size on UFortDataDrivenServiceBrief");
static_assert(offsetof(UFortDataDrivenServiceBrief, Text_TitleBar) == 0x000288, "Member 'UFortDataDrivenServiceBrief::Text_TitleBar' has a wrong offset!");
static_assert(offsetof(UFortDataDrivenServiceBrief, RichText_Description) == 0x000290, "Member 'UFortDataDrivenServiceBrief::RichText_Description' has a wrong offset!");
static_assert(offsetof(UFortDataDrivenServiceBrief, Text_StockRemaining) == 0x000298, "Member 'UFortDataDrivenServiceBrief::Text_StockRemaining' has a wrong offset!");
static_assert(offsetof(UFortDataDrivenServiceBrief, TransactionStrip_Main) == 0x0002A0, "Member 'UFortDataDrivenServiceBrief::TransactionStrip_Main' has a wrong offset!");
static_assert(offsetof(UFortDataDrivenServiceBrief, ServiceConfigs) == 0x0002A8, "Member 'UFortDataDrivenServiceBrief::ServiceConfigs' has a wrong offset!");
...
static_assert(sizeof(UFortTransactionStrip) == 0x000278, "Wrong size on UFortTransactionStrip");
...
{
public:
	class UButton*                                MobileButtonConfirm;                               // 0x04B8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UButton*                                MobileButtonTouchInformation;                      // 0x04C0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMobileConversationScreen) == 0x0004D0, "Wrong size on UMobileConversationScreen");
static_assert(offsetof(UMobileConversationScreen, MobileButtonConfirm) == 0x0004B8, "Member 'UMobileConversationScreen::MobileButtonConfirm' has a wrong offset!");
static_assert(offsetof(UMobileConversationScreen, MobileButtonTouchInformation) == 0x0004C0, "Member 'UMobileConversationScreen::MobileButtonTouchInformation' has a wrong offset!");
