...
static_assert(sizeof(ADA_Glider_Item_C) == 0x000E50, "Wrong size on ADA_Glider_Item_C");
static_assert(offsetof(ADA_Glider_Item_C, UberGraphFrame) == 0x000E28, "Member 'ADA_Glider_Item_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ADA_Glider_Item_C, ErrorReason) == 0x000E30, "Member 'ADA_Glider_Item_C::ErrorReason' has a wrong offset!");
