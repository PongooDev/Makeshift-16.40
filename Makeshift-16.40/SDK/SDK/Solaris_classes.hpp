...
{
public:
	uint32                                        SolClassFlags;                                     // 0x0238(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_23C[0x4];                                      // 0x023C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<class FName, class UClass*>              CoroClasses;                                       // 0x0240(0x0050)(NativeAccessSpecifierPublic)
	TArray<class UClass*>                         CoroBaseClasses;                                   // 0x0290(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TSet<class UClass*>                           TraitClasses;                                      // 0x02A0(0x0050)(NativeAccessSpecifierPublic)
...
static_assert(offsetof(USolarisGeneratedClass, SolClassFlags) == 0x000238, "Member 'USolarisGeneratedClass::SolClassFlags' has a wrong offset!");
static_assert(offsetof(USolarisGeneratedClass, CoroClasses) == 0x000240, "Member 'USolarisGeneratedClass::CoroClasses' has a wrong offset!");
static_assert(offsetof(USolarisGeneratedClass, CoroBaseClasses) == 0x000290, "Member 'USolarisGeneratedClass::CoroBaseClasses' has a wrong offset!");
static_assert(offsetof(USolarisGeneratedClass, TraitClasses) == 0x0002A0, "Member 'USolarisGeneratedClass::TraitClasses' has a wrong offset!");
