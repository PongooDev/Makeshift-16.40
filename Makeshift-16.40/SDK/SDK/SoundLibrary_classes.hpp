...
static_assert(sizeof(UAnimNotifyState_SoundLibrary) == 0x000078, "Wrong size on UAnimNotifyState_SoundLibrary");
...
static_assert(offsetof(UAnimNotifyState_SoundLibrary, PlayingComps) == 0x000038, "Member 'UAnimNotifyState_SoundLibrary::PlayingComps' has a wrong offset!");
static_assert(offsetof(UAnimNotifyState_SoundLibrary, PlaybackResult) == 0x000048, "Member 'UAnimNotifyState_SoundLibrary::PlaybackResult' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(const struct FGameplayTag& EventName, class USoundLibraryContext* Context)> OnSoundLibraryPlayEvent;                           // 0x00B0(0x0010)(ZeroConstructor, Transient, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(offsetof(USoundLibraryComponent, bAutoEnable) == 0x0000D0, "Member 'USoundLibraryComponent::bAutoEnable' has a wrong offset!");
...
{
public:
	struct FSimpleSoundLibraryContextSettings     Settings;                                          // 0x0030(0x000C)(Edit, BlueprintVisible, NoDestructor, ExposeOnSpawn, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USimpleSoundLibraryContext) == 0x000040, "Wrong size on USimpleSoundLibraryContext");
