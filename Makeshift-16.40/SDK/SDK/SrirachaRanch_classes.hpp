...
static_assert(sizeof(URadioContentSourceItemDefinition) == 0x0003D8, "Wrong size on URadioContentSourceItemDefinition");
static_assert(offsetof(URadioContentSourceItemDefinition, ResourceID) == 0x0003C0, "Member 'URadioContentSourceItemDefinition::ResourceID' has a wrong offset!");
static_assert(offsetof(URadioContentSourceItemDefinition, MediaSource) == 0x0003D0, "Member 'URadioContentSourceItemDefinition::MediaSource' has a wrong offset!");
