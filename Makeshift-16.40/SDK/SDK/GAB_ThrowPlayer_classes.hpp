...
static_assert(sizeof(UGAB_ThrowPlayer_C) == 0x000AB0, "Wrong size on UGAB_ThrowPlayer_C");
static_assert(offsetof(UGAB_ThrowPlayer_C, UberGraphFrame) == 0x000AA0, "Member 'UGAB_ThrowPlayer_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGAB_ThrowPlayer_C, PlayerPawn) == 0x000AA8, "Member 'UGAB_ThrowPlayer_C::PlayerPawn' has a wrong offset!");
